...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider {
   ...
   /** Chunks that have been requested to be unloaded */
    ...
    * set chunk level.
    *  
    * @param holder The {@link net.minecraft.world.server.ChunkHolder} of the chunk if it is loaded
    */
   @Nullable
