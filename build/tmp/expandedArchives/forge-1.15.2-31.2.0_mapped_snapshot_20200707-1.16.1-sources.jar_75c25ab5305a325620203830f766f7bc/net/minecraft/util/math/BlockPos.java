...
public class BlockPos extends Vec3i implements IDynamicSerializable {
    ...
    *  
    * <p>When storing a BlockPos given to you for an extended period of time
    */
    ...
    *  
    * This method uses {@link BlockPos.MutableBlockPos MutableBlockPos} instead of regular BlockPos
    */
