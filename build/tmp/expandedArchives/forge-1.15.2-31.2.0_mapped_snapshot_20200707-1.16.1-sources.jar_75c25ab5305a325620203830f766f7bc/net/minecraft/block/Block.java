...
public class Block extends net.minecraftforge.registries.ForgeRegistryEntry<Block> implements IItemProvider, net.minecraftforge.common.extensions.IForgeBlock {
    ...
    * @deprecated call via {@link IBlockState#getMapColor(IBlockAccess
    */
   @Deprecated
   ...
   /**
    * @deprecated call via {@link IBlockState#getBlockHardness(World
    */
   @Deprecated
   ...
   /**
    * @deprecated call via {@link IBlockState#getOffset(IBlockAccess
    */
   @Deprecated
