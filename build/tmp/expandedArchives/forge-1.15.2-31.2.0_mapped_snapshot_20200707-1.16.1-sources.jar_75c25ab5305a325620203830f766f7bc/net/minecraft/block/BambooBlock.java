...
public class BambooBlock extends Block implements IGrowable {
   ...
   /**
    * Returns the number of continuous bamboo blocks above the position passed in
    */
   ...
   /**
    * Returns the number of continuous bamboo blocks below the position passed in
    */
