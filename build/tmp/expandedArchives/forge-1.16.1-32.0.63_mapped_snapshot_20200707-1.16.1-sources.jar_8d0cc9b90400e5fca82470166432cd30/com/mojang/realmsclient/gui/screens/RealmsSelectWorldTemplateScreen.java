...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_224517_c.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      if (this.field_224531_q != null) {
         this.func_237992_a_(p_230430_1_, p_230430_2_, p_230430_3_, this.field_224531_q);
      }

      this.drawCenteredString(p_230430_1_, this.font, this.field_224519_e, this.width / 2, 13, 16777215);
         ...
         for(int i1 = 0; i1 < aitextcomponent.length; ++i1) {
            ...
            if (this.field_224528_n != null) {
               if (this.field_224530_p) {
                  j1 = 7107012;
                  itextcomponent = itextcomponent.deepCopy().func_240699_a_(TextFormatting.STRIKETHROUGH);
               } else {
                  j1 = 3368635;
               }
            }

            this.drawCenteredString(p_230430_1_, this.font, itextcomponent, this.width / 2, func_239562_k_(-1 + i1), j1);
         }
      }
   ...
   class WorldTemplateSelectionList extends RealmsObjectSelectionList<RealmsSelectWorldTemplateScreen.WorldTemplateSelectionEntry> {
      ...
      public boolean mouseClicked(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
         if (p_231044_5_ == 0 && p_231044_3_ >= (double)this.y0 && p_231044_3_ <= (double)this.y1) {
            ...
            if (p_231044_1_ >= (double)i && p_231044_1_ < (double)this.getScrollbarPosition() && k >= 0 && j >= 0 && k < this.getItemCount()) {
               ...
               this.func_231401_a_(j, k, p_231044_1_, p_231044_3_, this.width);
      ...
      public void setSelected(@Nullable RealmsSelectWorldTemplateScreen.WorldTemplateSelectionEntry p_241215_1_) {
         ...
         RealmsSelectWorldTemplateScreen.this.field_224518_d = this.children().indexOf(p_241215_1_);
