...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_224119_f.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.field_224127_n.func_239560_a_(this, p_230430_1_);
      this.font.drawString(p_230430_1_, I18n.format("mco.configure.world.backup"), (float)((this.width - 150) / 2 - 90), 20.0F, 10526880);
      if (this.field_224125_l) {
         this.font.drawString(p_230430_1_, I18n.format("mco.backup.nobackups"), 20.0F, (float)(this.height / 2 - 10), 16777215);
      }
   ...
   class BackupObjectSelectionList extends RealmsObjectSelectionList<RealmsBackupScreen.BackupObjectSelectionListEntry> {
      ...
      public void setSelected(@Nullable RealmsBackupScreen.BackupObjectSelectionListEntry p_241215_1_) {
         ...
         RealmsBackupScreen.this.field_224120_g = this.children().indexOf(p_241215_1_);
         RealmsBackupScreen.this.func_224113_d();
      }
   }
