...
public class RealmsGenericErrorScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.field_224229_b, this.width / 2, 80, 16777215);
      this.drawCenteredString(p_230430_1_, this.font, this.field_224230_c, this.width / 2, 100, 16711680);
