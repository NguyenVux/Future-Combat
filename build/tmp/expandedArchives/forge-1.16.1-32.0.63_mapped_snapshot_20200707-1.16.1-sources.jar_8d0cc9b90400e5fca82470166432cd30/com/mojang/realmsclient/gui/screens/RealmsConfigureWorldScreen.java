...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, I18n.format("mco.configure.worlds.title"), this.width / 2, func_239562_k_(4), 16777215);
      super.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      if (this.field_224416_d == null) {
         this.drawCenteredString(p_230430_1_, this.font, I18n.format("mco.configure.world.title"), this.width / 2, 17, 16777215);
      } else {
         ...
         this.drawCenteredString(p_230430_1_, this.font, I18n.format("mco.configure.world.title"), this.width / 2, 12, 16777215);
         this.drawCenteredString(p_230430_1_, this.font, s, this.width / 2, 24, j);
         ...
         if (this.func_224376_g()) {
            this.font.drawString(p_230430_1_, I18n.format("mco.configure.current.minigame") + ": " + this.field_224416_d.func_230778_c_(), (float)(this.field_224418_f + 80 + 20 + 10), (float)func_239562_k_(13), 16777215);
         }
