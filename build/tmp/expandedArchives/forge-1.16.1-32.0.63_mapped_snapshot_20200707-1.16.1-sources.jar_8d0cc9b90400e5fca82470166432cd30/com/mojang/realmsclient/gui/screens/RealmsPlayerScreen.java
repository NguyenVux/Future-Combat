...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.field_224304_e != null) {
         this.field_224304_e.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      }
      ...
      if (this.field_224303_d != null && this.field_224303_d.field_230589_h_ != null) {
         this.font.drawString(p_230430_1_, I18n.format("mco.configure.world.invited") + " (" + this.field_224303_d.field_230589_h_.size() + ")", (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      } else {
         this.font.drawString(p_230430_1_, I18n.format("mco.configure.world.invited"), (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      }
   ...
   class InvitedList extends RealmsObjectSelectionList<RealmsPlayerScreen.InvitedEntry> {
      ...
      public boolean mouseClicked(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
         if (p_231044_5_ == 0 && p_231044_1_ < (double)this.getScrollbarPosition() && p_231044_3_ >= (double)this.y0 && p_231044_3_ <= (double)this.y1) {
            ...
            if (p_231044_1_ >= (double)i && p_231044_1_ <= (double)j && l >= 0 && k >= 0 && l < this.getItemCount()) {
               ...
               this.func_231401_a_(k, l, p_231044_1_, p_231044_3_, this.width);
            }
      ...
      public void setSelected(@Nullable RealmsPlayerScreen.InvitedEntry p_241215_1_) {
         ...
         RealmsPlayerScreen.this.field_224312_m = this.children().indexOf(p_241215_1_);
         RealmsPlayerScreen.this.func_224280_a();
      }
