...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.font.drawString(p_230430_1_, I18n.format("mco.configure.world.invite.profile.name"), (float)(this.width / 2 - 100), (float)func_239562_k_(1), 10526880);
      if (this.field_224223_k) {
         this.drawCenteredString(p_230430_1_, this.font, this.field_224222_j, this.width / 2, func_239562_k_(5), 16711680);
      }

      this.field_224214_b.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
