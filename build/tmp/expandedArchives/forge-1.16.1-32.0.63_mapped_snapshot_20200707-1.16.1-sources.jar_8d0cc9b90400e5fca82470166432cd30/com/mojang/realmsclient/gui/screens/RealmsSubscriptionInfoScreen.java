...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.field_224586_h, this.width / 2, 17, 16777215);
      this.font.drawString(p_230430_1_, this.field_224587_i, (float)i, (float)func_239562_k_(0), 10526880);
      this.font.drawString(p_230430_1_, this.field_224591_m, (float)i, (float)func_239562_k_(1), 16777215);
      if (this.field_224592_n == Subscription.Type.NORMAL) {
         this.font.drawString(p_230430_1_, this.field_224588_j, (float)i, (float)func_239562_k_(3), 10526880);
      } else if (this.field_224592_n == Subscription.Type.RECURRING) {
         this.font.drawString(p_230430_1_, this.field_224589_k, (float)i, (float)func_239562_k_(3), 10526880);
      }

      this.font.drawString(p_230430_1_, this.func_224576_a(this.field_224590_l), (float)i, (float)func_239562_k_(4), 16777215);
