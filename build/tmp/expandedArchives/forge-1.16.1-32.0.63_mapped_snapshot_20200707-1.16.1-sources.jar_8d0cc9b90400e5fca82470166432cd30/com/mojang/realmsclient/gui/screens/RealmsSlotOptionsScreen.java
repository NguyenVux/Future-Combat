...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.font.drawString(p_230430_1_, s, (float)(this.field_224643_f + this.field_224644_g / 2 - this.font.getStringWidth(s) / 2), (float)(func_239562_k_(0) - 5), 16777215);
      this.field_224636_B.func_239560_a_(this, p_230430_1_);
      if (this.field_224637_C != null) {
         this.field_224637_C.func_239560_a_(this, p_230430_1_);
      }

      this.field_224642_e.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
