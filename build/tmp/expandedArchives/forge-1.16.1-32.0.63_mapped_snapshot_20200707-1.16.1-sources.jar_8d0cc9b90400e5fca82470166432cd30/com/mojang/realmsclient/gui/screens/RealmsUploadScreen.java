...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.field_224704_i, this.width / 2, 50, 16777215);
      if (this.field_224708_m) {
      ...
      if (this.field_224703_h != null) {
         for(int i = 0; i < this.field_224703_h.length; ++i) {
            this.drawCenteredString(p_230430_1_, this.font, this.field_224703_h[i], this.width / 2, 110 + 12 * i, 16711680);
         }
      }
