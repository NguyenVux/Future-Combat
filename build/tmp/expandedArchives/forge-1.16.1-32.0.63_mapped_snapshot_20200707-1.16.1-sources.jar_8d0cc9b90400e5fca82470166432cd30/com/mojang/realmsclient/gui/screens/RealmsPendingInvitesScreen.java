...
public class RealmsPendingInvitesScreen extends RealmsScreen {
      ...
      if (p_224321_1_ < this.field_224337_e.getItemCount()) {
         (new Thread("Realms-reject-invitation") {
            public void run() {
               try {
                  RealmsClient realmsclient = RealmsClient.func_224911_a();
                  realmsclient.func_224913_b((RealmsPendingInvitesScreen.this.field_224337_e.children().get(p_224321_1_)).field_223750_a.field_230563_a_);
                  RealmsPendingInvitesScreen.this.minecraft.execute(() -> {
      ...
      if (p_224329_1_ < this.field_224337_e.getItemCount()) {
         (new Thread("Realms-accept-invitation") {
            public void run() {
               try {
                  RealmsClient realmsclient = RealmsClient.func_224911_a();
                  realmsclient.func_224901_a((RealmsPendingInvitesScreen.this.field_224337_e.children().get(p_224329_1_)).field_223750_a.field_230563_a_);
                  RealmsPendingInvitesScreen.this.minecraft.execute(() -> {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_224337_e.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      ...
      if (this.field_224337_e.getItemCount() == 0 && this.field_224336_d) {
         this.drawCenteredString(p_230430_1_, this.font, I18n.format("mco.invites.nopending"), this.width / 2, this.height / 2 - 20, 16777215);
      }
   ...
   class InvitationList extends RealmsObjectSelectionList<RealmsPendingInvitesScreen.InvitationEntry> {
      ...
      public void setSelected(@Nullable RealmsPendingInvitesScreen.InvitationEntry p_241215_1_) {
         ...
         RealmsPendingInvitesScreen.this.field_224339_g = this.children().indexOf(p_241215_1_);
         RealmsPendingInvitesScreen.this.func_224331_b();
      }
   }
}