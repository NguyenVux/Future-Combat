...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.field_224178_d, this.width / 2, 20, 16777215);
      this.drawCenteredString(p_230430_1_, this.font, this.field_224184_j, this.width / 2, 50, 16777215);
      ...
      if (this.field_224183_i != null) {
         this.drawCenteredString(p_230430_1_, this.font, this.field_224183_i, this.width / 2, 110, 16711680);
      }
