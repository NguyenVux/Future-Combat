...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.field_237769_r_, this.width / 2, 17, 16777215);

      for(int i = 0; i < this.field_224077_g.length; ++i) {
         this.drawCenteredString(p_230430_1_, this.font, this.field_224077_g[i], this.width / 2, func_239562_k_(-1) + 3 + i * 12, 10526880);
      }
