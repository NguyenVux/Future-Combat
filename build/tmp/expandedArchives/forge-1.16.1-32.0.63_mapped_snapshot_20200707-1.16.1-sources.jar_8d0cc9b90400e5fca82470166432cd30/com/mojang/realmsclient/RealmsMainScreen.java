...
public class RealmsMainScreen extends RealmsScreen {
            ...
            public void run() {
               try {
                  ...
                  if (realmsserver != null) {
                     ...
                     RealmsMainScreen.this.field_224020_i.children().removeIf((p_237669_1_) -> {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_224020_i.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.func_237579_a_(p_230430_1_, this.width / 2 - 50, 7);
      if (RealmsClient.field_224944_a == RealmsClient.Environment.STAGE) {
      ...
      if (this.field_224037_z && !this.field_223993_A && this.func_223990_b()) {
         ...
         AbstractGui.blit(p_230430_1_, this.field_224009_Q.x + this.field_224009_Q.getWidth() - 8 - 4, this.field_224009_Q.y + this.field_224009_Q.func_238483_d_() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
      }
