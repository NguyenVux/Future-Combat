...
public class JigsawBlock extends Block implements ITileEntityProvider {
   public static final EnumProperty<JigsawOrientation> field_235506_a_ = BlockStateProperties.ORIENTATION;
   ...
   public BlockState mirror(BlockState state, Mirror mirrorIn) {
      return state.with(field_235506_a_, mirrorIn.getOrientation().func_235531_a_(state.get(field_235506_a_)));
   }
