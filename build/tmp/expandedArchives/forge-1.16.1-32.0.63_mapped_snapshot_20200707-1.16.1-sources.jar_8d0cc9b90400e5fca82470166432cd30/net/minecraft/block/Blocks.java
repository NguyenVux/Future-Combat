...
public class Blocks {
   ...
   public static final Block BEDROCK = register("bedrock", new Block(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(-1.0F, 3600000.0F).noDrops().setPropagatesDownwards(Blocks::func_235427_a_)));
   ...
   public static final Block NETHER_GOLD_ORE = register("nether_gold_ore", new OreBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(3.0F, 3.0F).sound(SoundType.field_235598_T_)));
   ...
   public static final Block GLASS = register("glass", new GlassBlock(AbstractBlock.Properties.create(Material.GLASS).hardnessAndResistance(0.3F).sound(SoundType.GLASS).notSolid().setPropagatesDownwards(Blocks::func_235427_a_).setOpaque(Blocks::func_235436_b_).setSuffocates(Blocks::func_235436_b_).setBlocksVision(Blocks::func_235436_b_)));
   ...
   public static final Block MOVING_PISTON = register("moving_piston", new MovingPistonBlock(AbstractBlock.Properties.create(Material.PISTON).hardnessAndResistance(-1.0F).variableOpacity().noDrops().notSolid().setOpaque(Blocks::func_235436_b_).setSuffocates(Blocks::func_235436_b_).setBlocksVision(Blocks::func_235436_b_)));
   ...
   public static final Block BROWN_MUSHROOM = register("brown_mushroom", new MushroomBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.BROWN).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT).setLightLevel((p_235417_0_) -> {
      return 1;
   }).setNeedsPostProcessing(Blocks::func_235426_a_)));
   public static final Block RED_MUSHROOM = register("red_mushroom", new MushroomBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.RED).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT).setNeedsPostProcessing(Blocks::func_235426_a_)));
   ...
   public static final Block FARMLAND = register("farmland", new FarmlandBlock(AbstractBlock.Properties.create(Material.EARTH).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.GROUND).setBlocksVision(Blocks::func_235426_a_)));
   public static final Block FURNACE = register("furnace", new FurnaceBlock(AbstractBlock.Properties.create(Material.ROCK).setRequiresTool().hardnessAndResistance(3.5F).setLightLevel(func_235420_a_(13))));
   ...
   public static final Block REDSTONE_ORE = register("redstone_ore", new RedstoneOreBlock(AbstractBlock.Properties.create(Material.ROCK).setRequiresTool().tickRandomly().setLightLevel(func_235420_a_(9)).hardnessAndResistance(3.0F, 3.0F)));
   public static final Block REDSTONE_TORCH = register("redstone_torch", new RedstoneTorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel(func_235420_a_(7)).sound(SoundType.WOOD)));
   public static final Block REDSTONE_WALL_TORCH = register("redstone_wall_torch", new RedstoneWallTorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel(func_235420_a_(7)).sound(SoundType.WOOD).lootFrom(REDSTONE_TORCH)));
   ...
   public static final Block ICE = register("ice", new IceBlock(AbstractBlock.Properties.create(Material.ICE).slipperiness(0.98F).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.GLASS).notSolid().setPropagatesDownwards((p_235450_0_, p_235450_1_, p_235450_2_, p_235450_3_) -> {
   ...
   public static final Block NETHERRACK = register("netherrack", new NetherrackBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(0.4F).sound(SoundType.field_235589_K_)));
   public static final Block SOUL_SAND = register("soul_sand", new SoulSandBlock(AbstractBlock.Properties.create(Material.SAND, MaterialColor.BROWN).hardnessAndResistance(0.5F).speedFactor(0.4F).sound(SoundType.field_235585_G_).setPropagatesDownwards(Blocks::func_235437_b_).setOpaque(Blocks::func_235426_a_).setBlocksVision(Blocks::func_235426_a_)));
   public static final Block SOUL_SOIL = register("soul_soil", new Block(AbstractBlock.Properties.create(Material.EARTH, MaterialColor.BROWN).hardnessAndResistance(0.5F).sound(SoundType.field_235586_H_)));
   public static final Block BASALT = register("basalt", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(1.25F, 4.2F).sound(SoundType.field_235587_I_)));
   public static final Block POLISHED_BASALT = register("polished_basalt", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(1.25F, 4.2F).sound(SoundType.field_235587_I_)));
   ...
   public static final Block CARVED_PUMPKIN = register("carved_pumpkin", new CarvedPumpkinBlock(AbstractBlock.Properties.create(Material.GOURD, MaterialColor.ADOBE).hardnessAndResistance(1.0F).sound(SoundType.WOOD).setPropagatesDownwards(Blocks::func_235437_b_)));
   public static final Block JACK_O_LANTERN = register("jack_o_lantern", new CarvedPumpkinBlock(AbstractBlock.Properties.create(Material.GOURD, MaterialColor.ADOBE).hardnessAndResistance(1.0F).sound(SoundType.WOOD).setLightLevel((p_235462_0_) -> {
      return 15;
   }).setPropagatesDownwards(Blocks::func_235437_b_)));
   ...
   public static final Block OAK_TRAPDOOR = register("oak_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   public static final Block SPRUCE_TRAPDOOR = register("spruce_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   public static final Block BIRCH_TRAPDOOR = register("birch_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.SAND).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   public static final Block JUNGLE_TRAPDOOR = register("jungle_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   public static final Block ACACIA_TRAPDOOR = register("acacia_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   public static final Block DARK_OAK_TRAPDOOR = register("dark_oak_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   ...
   public static final Block CHAIN = register("chain", new ChainBlock(AbstractBlock.Properties.create(Material.IRON, MaterialColor.AIR).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.field_235597_S_).notSolid()));
   ...
   public static final Block NETHER_BRICKS = register("nether_bricks", new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(2.0F, 6.0F).sound(SoundType.field_235590_L_)));
   public static final Block NETHER_BRICK_FENCE = register("nether_brick_fence", new FenceBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(2.0F, 6.0F).sound(SoundType.field_235590_L_)));
   ...
   public static final Block REDSTONE_LAMP = register("redstone_lamp", new RedstoneLampBlock(AbstractBlock.Properties.create(Material.REDSTONE_LIGHT).setLightLevel(func_235420_a_(15)).hardnessAndResistance(0.3F).sound(SoundType.GLASS).setPropagatesDownwards(Blocks::func_235437_b_)));
   ...
   public static final Block BEACON = register("beacon", new BeaconBlock(AbstractBlock.Properties.create(Material.GLASS, MaterialColor.DIAMOND).hardnessAndResistance(3.0F).setLightLevel((p_235456_0_) -> {
      return 15;
   }).notSolid().setOpaque(Blocks::func_235436_b_)));
   ...
   public static final Block REDSTONE_BLOCK = register("redstone_block", new RedstoneBlock(AbstractBlock.Properties.create(Material.IRON, MaterialColor.TNT).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL).setOpaque(Blocks::func_235436_b_)));
   public static final Block NETHER_QUARTZ_ORE = register("nether_quartz_ore", new OreBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(3.0F, 3.0F).sound(SoundType.field_235592_N_)));
   ...
   public static final Block BARRIER = register("barrier", new BarrierBlock(AbstractBlock.Properties.create(Material.BARRIER).hardnessAndResistance(-1.0F, 3600000.8F).noDrops().notSolid().setPropagatesDownwards(Blocks::func_235427_a_)));
   ...
   public static final Block NETHER_BRICK_SLAB = register("nether_brick_slab", new SlabBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(2.0F, 6.0F).sound(SoundType.field_235590_L_)));
   ...
   public static final Block GRASS_PATH = register("grass_path", new GrassPathBlock(AbstractBlock.Properties.create(Material.EARTH).hardnessAndResistance(0.65F).sound(SoundType.PLANT).setBlocksVision(Blocks::func_235426_a_)));
   ...
   public static final Block FROSTED_ICE = register("frosted_ice", new FrostedIceBlock(AbstractBlock.Properties.create(Material.ICE).slipperiness(0.98F).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.GLASS).notSolid().setPropagatesDownwards((p_235448_0_, p_235448_1_, p_235448_2_, p_235448_3_) -> {
   ...
   public static final Block MAGMA_BLOCK = register("magma_block", new MagmaBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().setLightLevel((p_235452_0_) -> {
      return 3;
   }).tickRandomly().hardnessAndResistance(0.5F).setPropagatesDownwards((p_235445_0_, p_235445_1_, p_235445_2_, p_235445_3_) -> {
      return p_235445_3_.isImmuneToFire();
   }).setNeedsPostProcessing(Blocks::func_235426_a_).setEmmisiveRendering(Blocks::func_235426_a_)));
   ...
   public static final Block RED_NETHER_BRICKS = register("red_nether_bricks", new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(2.0F, 6.0F).sound(SoundType.field_235590_L_)));
   public static final Block BONE_BLOCK = register("bone_block", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.SAND).setRequiresTool().hardnessAndResistance(2.0F).sound(SoundType.field_235593_O_)));
   ...
   public static final Block OBSERVER = register("observer", new ObserverBlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(3.0F).setRequiresTool().setOpaque(Blocks::func_235436_b_)));
   ...
   public static final Block SMOKER = register("smoker", new SmokerBlock(AbstractBlock.Properties.create(Material.ROCK).setRequiresTool().hardnessAndResistance(3.5F).setLightLevel(func_235420_a_(13))));
   public static final Block BLAST_FURNACE = register("blast_furnace", new BlastFurnaceBlock(AbstractBlock.Properties.create(Material.ROCK).setRequiresTool().hardnessAndResistance(3.5F).setLightLevel(func_235420_a_(13))));
   ...
   public static final Block CAMPFIRE = register("campfire", new CampfireBlock(true, 1, AbstractBlock.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD).setLightLevel(func_235420_a_(15)).notSolid()));
   public static final Block SOUL_CAMPFIRE = register("soul_campfire", new CampfireBlock(false, 2, AbstractBlock.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD).setLightLevel(func_235420_a_(10)).notSolid()));
   ...
   public static final Block WARPED_STEM = register("warped_stem", func_235428_a_(MaterialColor.field_241543_af_));
   public static final Block STRIPPED_WARPED_STEM = register("stripped_warped_stem", func_235428_a_(MaterialColor.field_241543_af_));
   public static final Block WARPED_HYPHAE = register("warped_hyphae", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.field_241544_ag_).hardnessAndResistance(2.0F).sound(SoundType.field_235602_z_)));
   public static final Block STRIPPED_WARPED_HYPHAE = register("stripped_warped_hyphae", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.field_241544_ag_).hardnessAndResistance(2.0F).sound(SoundType.field_235602_z_)));
   public static final Block WARPED_NYLIUM = register("warped_nylium", new NyliumBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.field_241542_ae_).setRequiresTool().hardnessAndResistance(0.4F).sound(SoundType.field_235579_A_).tickRandomly()));
   public static final Block WARPED_FUNGUS = register("warped_fungus", new FungusBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.CYAN).zeroHardnessAndResistance().doesNotBlockMovement().sound(SoundType.field_235580_B_), () -> {
      return Feature.field_236281_L_.withConfiguration(HugeFungusConfig.field_236301_d_);
   }));
   public static final Block WARPED_WART_BLOCK = register("warped_wart_block", new Block(AbstractBlock.Properties.create(Material.ORGANIC, MaterialColor.field_241545_ah_).hardnessAndResistance(1.0F).sound(SoundType.field_235588_J_)));
   public static final Block WARPED_ROOTS = register("warped_roots", new NetherRootsBlock(AbstractBlock.Properties.create(Material.TALL_PLANTS, MaterialColor.CYAN).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235581_C_)));
   public static final Block NETHER_SPROUTS = register("nether_sprouts", new NetherSproutsBlock(AbstractBlock.Properties.create(Material.TALL_PLANTS, MaterialColor.CYAN).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235591_M_)));
   public static final Block CRIMSON_STEM = register("crimson_stem", func_235428_a_(MaterialColor.field_241540_ac_));
   public static final Block STRIPPED_CRIMSON_STEM = register("stripped_crimson_stem", func_235428_a_(MaterialColor.field_241540_ac_));
   public static final Block CRIMSON_HYPHAE = register("crimson_hyphae", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.field_241541_ad_).hardnessAndResistance(2.0F).sound(SoundType.field_235602_z_)));
   public static final Block STRIPPED_CRIMSON_HYPHAE = register("stripped_crimson_hyphae", new RotatedPillarBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.field_241541_ad_).hardnessAndResistance(2.0F).sound(SoundType.field_235602_z_)));
   public static final Block CRIMSON_NYLIUM = register("crimson_nylium", new NyliumBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.field_241539_ab_).setRequiresTool().hardnessAndResistance(0.4F).sound(SoundType.field_235579_A_).tickRandomly()));
   public static final Block CRIMSON_FUNGUS = register("crimson_fungus", new FungusBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.NETHERRACK).zeroHardnessAndResistance().doesNotBlockMovement().sound(SoundType.field_235580_B_), () -> {
      return Feature.field_236281_L_.withConfiguration(HugeFungusConfig.field_236299_b_);
   }));
   public static final Block SHROOMLIGHT = register("shroomlight", new Block(AbstractBlock.Properties.create(Material.ORGANIC, MaterialColor.RED).hardnessAndResistance(1.0F).sound(SoundType.field_235582_D_).setLightLevel((p_235439_0_) -> {
      return 15;
   })));
   public static final Block WEEPING_VINES = register("weeping_vines", new WeepingVinesTopBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.NETHERRACK).tickRandomly().doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235583_E_)));
   public static final Block WEEPING_VINES_PLANT = register("weeping_vines_plant", new WeepingVinesBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.NETHERRACK).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235583_E_)));
   public static final Block TWISTING_VINES = register("twisting_vines", new TwistingVinesTopBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.CYAN).tickRandomly().doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235583_E_)));
   public static final Block TWISTING_VINES_PLANT = register("twisting_vines_plant", new TwistingVinesBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.CYAN).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235583_E_)));
   public static final Block CRIMSON_ROOTS = register("crimson_roots", new NetherRootsBlock(AbstractBlock.Properties.create(Material.TALL_PLANTS, MaterialColor.NETHERRACK).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.field_235581_C_)));
   public static final Block CRIMSON_PLANKS = register("crimson_planks", new Block(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.field_241540_ac_).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_PLANKS = register("warped_planks", new Block(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.field_241543_af_).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_SLAB = register("crimson_slab", new SlabBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.NETHERRACK).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_SLAB = register("warped_slab", new SlabBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_PRESSURE_PLATE = register("crimson_pressure_plate", new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.NETHERRACK).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
   public static final Block WARPED_PRESSURE_PLATE = register("warped_pressure_plate", new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.CYAN).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_FENCE = register("crimson_fence", new FenceBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.NETHERRACK).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_FENCE = register("warped_fence", new FenceBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_TRAPDOOR = register("crimson_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.NETHERRACK).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()));
   public static final Block WARPED_TRAPDOOR = register("warped_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.CYAN).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()));
   public static final Block CRIMSON_FENCE_GATE = register("crimson_fence_gate", new FenceGateBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.NETHERRACK).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_FENCE_GATE = register("warped_fence_gate", new FenceGateBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   ...
   public static final Block CRIMSON_DOOR = register("crimson_door", new DoorBlock(AbstractBlock.Properties.create(Material.field_237214_y_, CRIMSON_PLANKS.getMaterialColor()).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()));
   public static final Block WARPED_DOOR = register("warped_door", new DoorBlock(AbstractBlock.Properties.create(Material.field_237214_y_, WARPED_PLANKS.getMaterialColor()).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()));
   public static final Block CRIMSON_SIGN = register("crimson_sign", new StandingSignBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.NETHERRACK).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD), WoodType.field_235923_g_));
   public static final Block WARPED_SIGN = register("warped_sign", new StandingSignBlock(AbstractBlock.Properties.create(Material.field_237214_y_, MaterialColor.CYAN).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD), WoodType.field_235924_h_));
   public static final Block CRIMSON_WALL_SIGN = register("crimson_wall_sign", new WallSignBlock(AbstractBlock.Properties.create(Material.field_237214_y_).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(CRIMSON_SIGN), WoodType.field_235923_g_));
   public static final Block WARPED_WALL_SIGN = register("warped_wall_sign", new WallSignBlock(AbstractBlock.Properties.create(Material.field_237214_y_).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(WARPED_SIGN), WoodType.field_235924_h_));
   ...
   public static final Block NETHERITE_BLOCK = register("netherite_block", new Block(AbstractBlock.Properties.create(Material.IRON, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(50.0F, 1200.0F).sound(SoundType.field_235594_P_)));
   public static final Block ANCIENT_DEBRIS = register("ancient_debris", new Block(AbstractBlock.Properties.create(Material.IRON, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(30.0F, 1200.0F).sound(SoundType.field_235595_Q_)));
   ...
   public static final Block LODESTONE = register("lodestone", new Block(AbstractBlock.Properties.create(Material.ANVIL).setRequiresTool().hardnessAndResistance(3.5F).sound(SoundType.field_235596_R_)));
   ...
   public static final Block GILDED_BLACKSTONE = register("gilded_blackstone", new Block(AbstractBlock.Properties.from(BLACKSTONE).sound(SoundType.field_235599_U_)));
   ...
   public static final Block CHISELED_NETHER_BRICKS = register("chiseled_nether_bricks", new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(2.0F, 6.0F).sound(SoundType.field_235590_L_)));
   public static final Block CRACKED_NETHER_BRICKS = register("cracked_nether_bricks", new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().hardnessAndResistance(2.0F, 6.0F).sound(SoundType.field_235590_L_)));
   ...
   private static BedBlock func_235422_a_(DyeColor p_235422_0_) {
      return new BedBlock(p_235422_0_, AbstractBlock.Properties.create(Material.WOOL, (p_235424_1_) -> {
   ...
   private static Block func_235428_a_(MaterialColor p_235428_0_) {
      return new RotatedPillarBlock(AbstractBlock.Properties.create(Material.field_237214_y_, (p_235429_1_) -> {
         return p_235428_0_;
   ...
   private static StainedGlassBlock func_235434_b_(DyeColor p_235434_0_) {
      return new StainedGlassBlock(p_235434_0_, AbstractBlock.Properties.create(Material.GLASS, p_235434_0_).hardnessAndResistance(0.3F).sound(SoundType.GLASS).notSolid().setPropagatesDownwards(Blocks::func_235427_a_).setOpaque(Blocks::func_235436_b_).setSuffocates(Blocks::func_235436_b_).setBlocksVision(Blocks::func_235436_b_));
   }

   private static LeavesBlock func_235433_b_() {
      return new LeavesBlock(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT).notSolid().setPropagatesDownwards(Blocks::func_235441_c_).setSuffocates(Blocks::func_235436_b_).setBlocksVision(Blocks::func_235436_b_));
   }
   ...
   private static ShulkerBoxBlock func_235423_a_(DyeColor p_235423_0_, AbstractBlock.Properties p_235423_1_) {
      ...
      return new ShulkerBoxBlock(p_235423_0_, p_235423_1_.hardnessAndResistance(2.0F).variableOpacity().notSolid().setSuffocates(abstractblock$ipositionpredicate).setBlocksVision(abstractblock$ipositionpredicate));
   }
   ...
   private static PistonBlock func_235432_a_(boolean p_235432_0_) {
      ...
      return new PistonBlock(p_235432_0_, AbstractBlock.Properties.create(Material.PISTON).hardnessAndResistance(1.5F).setOpaque(Blocks::func_235436_b_).setSuffocates(abstractblock$ipositionpredicate).setBlocksVision(abstractblock$ipositionpredicate));
   }
