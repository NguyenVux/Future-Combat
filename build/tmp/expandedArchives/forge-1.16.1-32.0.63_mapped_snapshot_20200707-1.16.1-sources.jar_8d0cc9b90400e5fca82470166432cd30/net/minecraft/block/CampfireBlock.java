...
public class CampfireBlock extends ContainerBlock implements IWaterLoggable {
   ...
   /**
    * Returns true if the block of the passed blockstate is a Hay block
    */
   ...
   public static boolean func_226915_i_(BlockState p_226915_0_) {
      return p_226915_0_.func_235901_b_(LIT) && p_226915_0_.isIn(BlockTags.CAMPFIRES) && p_226915_0_.get(LIT);
   }
   ...
   public static boolean func_241470_h_(BlockState p_241470_0_) {
      return p_241470_0_.isInAndMatches(BlockTags.CAMPFIRES, (p_241469_0_) -> {
