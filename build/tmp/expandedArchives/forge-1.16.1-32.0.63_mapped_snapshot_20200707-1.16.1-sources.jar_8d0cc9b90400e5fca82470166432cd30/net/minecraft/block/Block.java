...
public class Block extends AbstractBlock implements IItemProvider, net.minecraftforge.common.extensions.IForgeBlock {
   ...
   public boolean matchesBlock(Block blockIn) {
      return this == blockIn;
   }

   /**
    * With the provided block state
    */
   ...
   /**
    * Replaces oldState with newState
    */
   ...
   public static void func_241468_a_(BlockState stateIn, BlockState state2In, IWorld worldIn, BlockPos posIn, int p_241468_4_, int p_241468_5_) {
      if (state2In != stateIn) {
         if (state2In.isAir()) {
            if (!worldIn.isRemote()) {
               worldIn.func_241212_a_(posIn, (p_241468_4_ & 32) == 0, (Entity)null, p_241468_5_);
            }
         } else {
            worldIn.func_241211_a_(posIn, state2In, p_241468_4_ & -33, p_241468_5_);
         }
      }
   ...
   /**
    * Spawns the given stack into the World at the given position
    */
