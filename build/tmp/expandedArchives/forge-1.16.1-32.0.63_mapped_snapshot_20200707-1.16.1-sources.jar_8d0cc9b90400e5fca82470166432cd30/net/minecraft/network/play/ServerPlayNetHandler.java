...
public class ServerPlayNetHandler implements IServerPlayNetHandler {
   ...
   /**
    * Teleports the player position to the (relative) values specified
    */
   ...
   /**
    * Called when a client is using an item while not pointing at a block
    */
   ...
   public void onDisconnect(ITextComponent reason) {
      ...
      this.server.getPlayerList().func_232641_a_((new TranslationTextComponent("multiplayer.player.left", this.player.getDisplayName())).func_240699_a_(TextFormatting.YELLOW), ChatType.SYSTEM, Util.DUMMY_UUID);
   ...
   public void processChatMessage(CChatMessagePacket packetIn) {
      ...
      if (this.player.getChatVisibility() == ChatVisibility.HIDDEN) {
         this.sendPacket(new SChatPacket((new TranslationTextComponent("chat.cannotSend")).func_240699_a_(TextFormatting.RED), ChatType.SYSTEM, Util.DUMMY_UUID));
      } else {
         this.player.markPlayerActive();
