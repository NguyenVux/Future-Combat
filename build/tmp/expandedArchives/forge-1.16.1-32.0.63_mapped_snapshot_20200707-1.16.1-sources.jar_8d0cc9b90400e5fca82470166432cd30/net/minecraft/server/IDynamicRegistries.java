...
public interface IDynamicRegistries {
   ...
   public static final class Impl implements IDynamicRegistries {
      public static final Codec<IDynamicRegistries.Impl> field_239771_a_ = SimpleRegistry.func_241743_a_(Registry.DIMENSION_TYPE_KEY, Lifecycle.experimental(), DimensionType.field_235997_a_).xmap(IDynamicRegistries.Impl::new, (p_239773_0_) -> {
