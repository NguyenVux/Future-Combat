...
public class Advancement {
   ...
   public Advancement(ResourceLocation id, @Nullable Advancement parentIn, @Nullable DisplayInfo displayIn, AdvancementRewards rewardsIn, Map<String, Criterion> criteriaIn, String[][] requirementsIn) {
      ...
      if (displayIn == null) {
         ...
         ITextComponent itextcomponent1 = TextComponentUtils.func_240648_a_(itextcomponent.deepCopy(), Style.EMPTY.setFormatting(textformatting)).func_240702_b_("\n").func_230529_a_(displayIn.getDescription());
         ITextComponent itextcomponent2 = itextcomponent.deepCopy().func_240700_a_((p_211567_1_) -> {
    ...
    * 
    * @return information that defines this {@code Advancement}'s appearance in GUIs. If {@code null}
    */
   @Nullable
    ...
    * completed. If this {@code Advancement} is {@linkplain #getDisplay() invisible}
    */
   ...
   public static class Builder {
      ...
      /**
       * Tries to resolve the parent of this advancement
       */
