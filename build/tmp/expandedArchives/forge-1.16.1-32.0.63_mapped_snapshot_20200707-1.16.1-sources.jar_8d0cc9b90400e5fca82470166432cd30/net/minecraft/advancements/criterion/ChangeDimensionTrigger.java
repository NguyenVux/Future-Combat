...
public class ChangeDimensionTrigger extends AbstractCriterionTrigger<ChangeDimensionTrigger.Instance> {
   ...
   public ChangeDimensionTrigger.Instance func_230241_b_(JsonObject p_230241_1_, EntityPredicate.AndPredicate p_230241_2_, ConditionArrayParser p_230241_3_) {
      RegistryKey<World> registrykey = p_230241_1_.has("from") ? RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation(JSONUtils.getString(p_230241_1_, "from"))) : null;
      RegistryKey<World> registrykey1 = p_230241_1_.has("to") ? RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation(JSONUtils.getString(p_230241_1_, "to"))) : null;
