...
public class LocationPredicate {
   ...
   public static LocationPredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         RegistryKey<World> registrykey = jsonobject.has("dimension") ? ResourceLocation.RESOURCE_LOCATION_CODEC.parse(JsonOps.INSTANCE, jsonobject.get("dimension")).resultOrPartial(field_235305_b_::error).map((p_235310_0_) -> {
