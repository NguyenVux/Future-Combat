...
public class SearchTreeReloadable<T> implements IMutableSearchTree<T> {
   ...
   /**
    * Recalculates the contents of this search tree
    */
   ...
   /**
    * Directly puts the given item into {@link #byId} and {@link #byName}
    */
   ...
   /**
    * Compares two elements. Returns {@code 1} if the first element has more entries
    */
