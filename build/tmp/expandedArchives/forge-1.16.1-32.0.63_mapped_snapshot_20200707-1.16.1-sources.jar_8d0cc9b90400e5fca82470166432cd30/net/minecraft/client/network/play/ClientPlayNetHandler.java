...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   /** The NetworkManager instance used to communicate with the server */
    ...
    * subclassing of the packet allows for the specification of a subset of this data (e.g. only rel. position
    */
   ...
   public void handleRespawn(SRespawnPacket packetIn) {
      ...
      if (packetIn.func_240830_h_()) {
         clientplayerentity1.getAttributeManager().func_233784_a_(clientplayerentity.getAttributeManager());
      }
    ...
    * a MerchantRecipeList trades for a villager merchant
    */
