...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
   ...
   private void func_238207_b_(String p_238207_1_) {
      if (!this.isIntegratedServerRunning() && !this.func_238217_s_()) {
         if (this.player != null) {
            this.player.sendMessage((new TranslationTextComponent("chat.cannotSend")).func_240699_a_(TextFormatting.RED), Util.DUMMY_UUID);
         }
      } else {
    ...
    * may cause many different issues
    */
   ...
   public void func_238192_a_(String p_238192_1_, WorldSettings p_238192_2_, IDynamicRegistries.Impl p_238192_3_, DimensionGeneratorSettings p_238192_4_) {
      this.func_238195_a_(p_238192_1_, p_238192_3_, (p_238179_1_) -> {
         ...
         DataResult<SimpleRegistry<Dimension>> dataresult = worldsettingsimport.func_241797_a_(p_238192_4_.func_236224_e_(), Registry.DIMENSION_KEY, Dimension.field_236052_a_);
