...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener {
   ...
   /**
    * Adds the given text after the cursor
    */
   ...
   /**
    * Like getNthWordFromPos (which wraps this)
    */
   ...
   /**
    * Sets the maximum length for the text in this text box. If the current text is longer than this length
    */
    ...
    * selection). If the anchor is set beyond the bounds of the current text
    */
