...
public class KeyBindingList extends AbstractOptionList<KeyBindingList.Entry> {
   ...
   public class KeyEntry extends KeyBindingList.Entry {
      ...
      public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         ...
         if (flag) {
            this.btnChangeKeyBinding.setMessage((new StringTextComponent("> ")).func_230529_a_(this.btnChangeKeyBinding.getMessage().deepCopy().func_240699_a_(TextFormatting.YELLOW)).func_240702_b_(" <").func_240699_a_(TextFormatting.YELLOW));
         } else if (flag1) {
            this.btnChangeKeyBinding.setMessage(this.btnChangeKeyBinding.getMessage().deepCopy().func_240699_a_(keyCodeModifierConflict ? TextFormatting.GOLD : TextFormatting.RED));
         }
