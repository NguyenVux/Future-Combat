...
public class EnchantmentScreen extends ContainerScreen<EnchantmentContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      for(int i1 = 0; i1 < 3; ++i1) {
         ...
         if (l1 == 0) {
            ...
            this.font.drawStringWithShadow(p_230450_1_, s, (float)(k1 + 86 - this.font.getStringWidth(s)), (float)(j + 16 + 19 * i1 + 7), j2);
         }
      }
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      p_230430_4_ = this.minecraft.getRenderPartialTicks();
