...
public class FlatPresetsScreen extends Screen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawString(p_230430_1_, this.font, this.presetsShare, 50, 30, 10526880);
      this.drawString(p_230430_1_, this.font, this.listText, 50, 70, 10526880);
   ...
   class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry> {
      ...
      public void setSelected(@Nullable FlatPresetsScreen.SlotList.PresetEntry p_241215_1_) {
         ...
         if (p_241215_1_ != null) {
            NarratorChatListener.INSTANCE.say((new TranslationTextComponent("narrator.select", FlatPresetsScreen.FLAT_WORLD_PRESETS.get(this.children().indexOf(p_241215_1_)).func_238644_a_())).getString());
         }
      ...
      public class PresetEntry extends ExtendedList.AbstractListEntry<FlatPresetsScreen.SlotList.PresetEntry> {
         ...
         private void func_214399_a() {
            ...
            FlatPresetsScreen.LayerItem flatpresetsscreen$layeritem = FlatPresetsScreen.FLAT_WORLD_PRESETS.get(SlotList.this.children().indexOf(this));
