   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (!this.func_238718_l_()) {
         ...
         this.field_238707_q_.ifPresent((p_238712_2_) -> {
            this.drawCenteredString(p_230430_1_, this.font, p_238712_2_.func_238725_a_(), this.width / 2, this.height / 2 - 30 - 20, -1);
         });
         this.drawCenteredString(p_230430_1_, this.font, field_238705_c_, this.width / 2, this.height / 2 + 5, 16777215);
