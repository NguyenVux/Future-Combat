...
public class MerchantScreen extends ContainerScreen<MerchantContainer> {
   ...
   protected void func_230451_b_(MatrixStack p_230451_1_, int p_230451_2_, int p_230451_3_) {
      ...
      if (i > 0 && i <= 5 && this.container.func_217042_i()) {
         ...
         this.font.func_238422_b_(p_230451_1_, this.title, (float)i1, 6.0F, 4210752);
         this.font.drawString(p_230451_1_, s, (float)(i1 + j + 3), 6.0F, 4210752);
      } else {
         this.font.func_238422_b_(p_230451_1_, this.title, (float)(49 + this.xSize / 2 - this.font.func_238414_a_(this.title) / 2), 6.0F, 4210752);
      }
      ...
      this.font.drawString(p_230451_1_, s1, (float)(5 - j1 / 2 + 48), 6.0F, 4210752);
   }
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      int i = (this.width - this.xSize) / 2;
      int j = (this.height - this.ySize) / 2;
      blit(p_230450_1_, i, j, this.getBlitOffset(), 0.0F, 0.0F, this.xSize, this.ySize, 256, 512);
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         if (merchantoffer.hasNoUsesLeft()) {
            this.minecraft.getTextureManager().bindTexture(MERCHANT_GUI_TEXTURE);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            blit(p_230450_1_, this.guiLeft + 83 + 99, this.guiTop + 35, this.getBlitOffset(), 311.0F, 0.0F, 28, 21, 256, 512);
         }
      }
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         if (merchantoffer1.hasNoUsesLeft() && this.isPointInRegion(186, 35, 22, 21, (double)p_230430_2_, (double)p_230430_3_) && this.container.func_223432_h()) {
            this.renderTooltip(p_230430_1_, new TranslationTextComponent("merchant.deprecated"), p_230430_2_, p_230430_3_);
         }
