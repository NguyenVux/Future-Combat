...
public class StatsScreen extends Screen implements IProgressMeter {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (this.doesGuiPauseGame) {
         ...
         this.drawCenteredString(p_230430_1_, this.font, I18n.format("multiplayer.downloadingStats"), this.width / 2, this.height / 2, 16777215);
         this.drawCenteredString(p_230430_1_, this.font, LOADING_STRINGS[(int)(Util.milliTime() / 150L % (long)LOADING_STRINGS.length)], this.width / 2, this.height / 2 + 9 * 2, 16777215);
      } else {
         this.func_213116_d().render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
