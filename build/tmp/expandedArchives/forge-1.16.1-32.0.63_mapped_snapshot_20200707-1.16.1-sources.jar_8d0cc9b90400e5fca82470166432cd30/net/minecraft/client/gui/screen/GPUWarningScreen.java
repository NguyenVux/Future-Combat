...
public class GPUWarningScreen extends Screen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.title, this.width / 2, this.field_241588_p_ - 9 * 2, -1);
      int i = this.field_241588_p_;

      for(ITextProperties itextproperties : this.field_241587_c_) {
         this.drawCenteredString(p_230430_1_, this.font, itextproperties, this.width / 2, i, -1);
         i += 9;
      }
