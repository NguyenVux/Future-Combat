   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      if (this.horseEntity instanceof AbstractChestedHorseEntity) {
         ...
         if (abstractchestedhorseentity.hasChest()) {
            this.blit(p_230450_1_, i + 79, j + 17, 0, this.ySize, abstractchestedhorseentity.getInventoryColumns() * 18, 54);
         }
      }

      if (this.horseEntity.func_230264_L__()) {
         this.blit(p_230450_1_, i + 7, j + 35 - 18, 18, this.ySize + 54, 18, 18);
      }

      if (this.horseEntity.func_230276_fq_()) {
         if (this.horseEntity instanceof LlamaEntity) {
            this.blit(p_230450_1_, i + 7, j + 35, 36, this.ySize + 54, 18, 18);
         } else {
            this.blit(p_230450_1_, i + 7, j + 35, 0, this.ySize + 54, 18, 18);
         }
      }
