...
public class EditStructureScreen extends Screen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.drawCenteredString(p_230430_1_, this.font, this.title, this.width / 2, 10, 16777215);
      if (structuremode != StructureMode.DATA) {
         this.drawString(p_230430_1_, this.font, I18n.format("structure_block.structure_name"), this.width / 2 - 153, 30, 10526880);
      ...
      if (structuremode == StructureMode.LOAD || structuremode == StructureMode.SAVE) {
         this.drawString(p_230430_1_, this.font, I18n.format("structure_block.position"), this.width / 2 - 153, 70, 10526880);
         ...
         this.drawString(p_230430_1_, this.font, s, this.width / 2 + 154 - i, 150, 10526880);
      }

      if (structuremode == StructureMode.SAVE) {
         this.drawString(p_230430_1_, this.font, I18n.format("structure_block.size"), this.width / 2 - 153, 110, 10526880);
         ...
         this.drawString(p_230430_1_, this.font, s2, this.width / 2 + 154 - k, 110, 10526880);
         String s1 = I18n.format("structure_block.show_air");
         int j = this.font.getStringWidth(s1);
         this.drawString(p_230430_1_, this.font, s1, this.width / 2 + 154 - j, 70, 10526880);
      }

      if (structuremode == StructureMode.LOAD) {
         this.drawString(p_230430_1_, this.font, I18n.format("structure_block.integrity"), this.width / 2 - 153, 110, 10526880);
         ...
         this.drawString(p_230430_1_, this.font, s3, this.width / 2 + 154 - l, 70, 10526880);
      }

      if (structuremode == StructureMode.DATA) {
         this.drawString(p_230430_1_, this.font, I18n.format("structure_block.custom_data"), this.width / 2 - 153, 110, 10526880);
      ...
      this.drawString(p_230430_1_, this.font, I18n.format(s4), this.width / 2 - 153, 174, 10526880);
