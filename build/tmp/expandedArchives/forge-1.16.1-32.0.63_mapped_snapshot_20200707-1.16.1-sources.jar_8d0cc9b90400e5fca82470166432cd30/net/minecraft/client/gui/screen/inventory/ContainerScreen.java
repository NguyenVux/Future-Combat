...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
   ...
   protected void func_230459_a_(MatrixStack p_230459_1_, int p_230459_2_, int p_230459_3_) {
      if (this.minecraft.player.inventory.getItemStack().isEmpty() && this.hoveredSlot != null && this.hoveredSlot.getHasStack()) {
         this.renderTooltip(p_230459_1_, this.hoveredSlot.getStack(), p_230459_2_, p_230459_3_);
      }
    ...
    * Draws an ItemStack.
    *  
    * The z index is increased by 32 (and not decreased afterwards)
    */
   ...
   private void func_241609_a_(int p_241609_1_) {
      if (this.hoveredSlot != null && this.minecraft.player.inventory.getItemStack().isEmpty()) {
         if (this.minecraft.gameSettings.keyBindSwapHands.matchesMouseKey(p_241609_1_)) {
            this.handleMouseClick(this.hoveredSlot, this.hoveredSlot.slotNumber, 40, ClickType.SWAP);
            return;
         }

         for(int i = 0; i < 9; ++i) {
            if (this.minecraft.gameSettings.keyBindsHotbar[i].matchesMouseKey(p_241609_1_)) {
   ...
   public boolean keyPressed(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      ...
      if (super.keyPressed(p_231046_1_, p_231046_2_, p_231046_3_)) {
         return true;
      } else if (p_231046_1_ != 256 && !this.minecraft.gameSettings.keyBindInventory.isActiveAndMatches(mouseKey)) {
