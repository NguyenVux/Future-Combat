...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable {
   ...
   protected <T extends Widget> T addButton(T p_230480_1_) {
      ...
      return this.addListener(p_230480_1_);
   }
   ...
   protected void renderTooltip(MatrixStack p_230457_1_, ItemStack p_230457_2_, int p_230457_3_, int p_230457_4_) {
      ...
      this.renderTooltip(p_230457_1_, this.getTooltipFromItem(p_230457_2_), p_230457_3_, p_230457_4_, (font == null ? this.font : font));
      net.minecraftforge.fml.client.gui.GuiUtils.postItemToolTip();
   }

   public List<ITextComponent> getTooltipFromItem(ItemStack p_231151_1_) {
      return p_231151_1_.getTooltip(this.minecraft.player, this.minecraft.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
   }

   public void renderTooltip(MatrixStack p_238652_1_, ITextProperties p_238652_2_, int p_238652_3_, int p_238652_4_) {
   ...
   protected void renderComponentHoverEffect(MatrixStack p_238653_1_, @Nullable Style p_238653_2_, int p_238653_3_, int p_238653_4_) {
      if (p_238653_2_ != null && p_238653_2_.getHoverEvent() != null) {
         ...
         HoverEvent.ItemHover hoverevent$itemhover = hoverevent.func_240662_a_(HoverEvent.Action.SHOW_ITEM);
         if (hoverevent$itemhover != null) {
            this.renderTooltip(p_238653_1_, hoverevent$itemhover.func_240689_a_(), p_238653_3_, p_238653_4_);
         } else {
            HoverEvent.EntityHover hoverevent$entityhover = hoverevent.func_240662_a_(HoverEvent.Action.SHOW_ENTITY);
            if (hoverevent$entityhover != null) {
               if (this.minecraft.gameSettings.advancedItemTooltips) {
                  this.renderTooltip(p_238653_1_, hoverevent$entityhover.func_240684_b_(), p_238653_3_, p_238653_4_);
               }
            } else {
               ITextComponent itextcomponent = hoverevent.func_240662_a_(HoverEvent.Action.SHOW_TEXT);
               if (itextcomponent != null) {
                  this.renderTooltip(p_238653_1_, this.minecraft.fontRenderer.func_238425_b_(itextcomponent, Math.max(this.width / 2, 200)), p_238653_3_, p_238653_4_);
               }
            }
         }
   ...
   public void sendMessage(String p_231159_1_, boolean p_231159_2_) {
      ...
      this.minecraft.player.sendChatMessage(p_231159_1_);
   }
   ...
   public void renderDirtBackground(int p_231165_1_) {
      ...
      bufferbuilder.pos(0.0D, (double)this.height, 0.0D).tex(0.0F, (float)this.height / 32.0F + (float)p_231165_1_).color(64, 64, 64, 255).endVertex();
      bufferbuilder.pos((double)this.width, (double)this.height, 0.0D).tex((float)this.width / 32.0F, (float)this.height / 32.0F + (float)p_231165_1_).color(64, 64, 64, 255).endVertex();
