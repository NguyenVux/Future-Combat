...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      if (!slot.getHasStack()) {
         this.blit(p_230450_1_, i + slot.xPos, j + slot.yPos, this.xSize, 0, 16, 16);
      }

      if (!slot1.getHasStack()) {
         this.blit(p_230450_1_, i + slot1.xPos, j + slot1.yPos, this.xSize + 16, 0, 16, 16);
      }

      if (!slot2.getHasStack()) {
         this.blit(p_230450_1_, i + slot2.xPos, j + slot2.yPos, this.xSize + 32, 0, 16, 16);
      }

      int k = (int)(41.0F * this.field_214126_x);
      this.blit(p_230450_1_, i + 119, j + 13 + k, 232 + (this.field_214123_u ? 0 : 12), 0, 12, 15);
      ...
      if (this.field_230155_n_ != null && !this.field_214125_w) {
         ...
         this.blit(p_230450_1_, i + slot3.xPos - 2, j + slot3.yPos - 2, this.xSize, 17, 17, 16);
      }
      ...
      if (this.field_214123_u) {
         ...
         int i3 = j + 13;
         this.minecraft.getTextureManager().bindTexture(field_214113_k);
         this.blit(p_230450_1_, k2, i3, 0, this.ySize, 14, 14);
