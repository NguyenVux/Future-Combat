...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   public boolean keyPressed(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      ...
      if (!ItemGroup.GROUPS[selectedTabIndex].hasSearchBar()) {
         if (this.minecraft.gameSettings.keyBindChat.matchesKey(p_231046_1_, p_231046_2_)) {
         ...
         if (flag && flag1 && this.func_195363_d(p_231046_1_, p_231046_2_)) {
            ...
            String s = this.searchField.getText();
            if (this.searchField.keyPressed(p_231046_1_, p_231046_2_, p_231046_3_)) {
               if (!Objects.equals(s, this.searchField.getText())) {
                  this.updateCreativeSearch();
               }
               ...
               return this.searchField.isFocused() && this.searchField.getVisible() && p_231046_1_ != 256 ? true : super.keyPressed(p_231046_1_, p_231046_2_, p_231046_3_);
            }
         }
      }
   }
   ...
   protected void func_230451_b_(MatrixStack p_230451_1_, int p_230451_2_, int p_230451_3_) {
      ...
      if (itemgroup != null && itemgroup.drawInForegroundOfTab()) {
         ...
         this.font.drawString(p_230451_1_, I18n.format(itemgroup.getTranslationKey()), 8.0F, 6.0F, itemgroup.getLabelColor());
      }
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.destroyItemSlot != null && selectedTabIndex == ItemGroup.INVENTORY.getIndex() && this.isPointInRegion(this.destroyItemSlot.xPos, this.destroyItemSlot.yPos, 16, 16, (double)p_230430_2_, (double)p_230430_3_)) {
         this.renderTooltip(p_230430_1_, new TranslationTextComponent("inventory.binSlot"), p_230430_2_, p_230430_3_);
      }
      ...
      if (maxPages != 0) {
          ...
          font.func_238407_a_(p_230430_1_, page, guiLeft + (xSize / 2) - (font.func_238414_a_(page) / 2), guiTop - 44, -1);
   ...
   protected void renderTooltip(MatrixStack p_230457_1_, ItemStack p_230457_2_, int p_230457_3_, int p_230457_4_) {
      if (selectedTabIndex == ItemGroup.SEARCH.getIndex()) {
         List<ITextComponent> list = p_230457_2_.getTooltip(this.minecraft.player, this.minecraft.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
         ...
         this.renderTooltip(p_230457_1_, list1, p_230457_3_, p_230457_4_, (font == null ? this.font : font));
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      this.searchField.render(p_230450_1_, p_230450_3_, p_230450_4_, p_230450_2_);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      ...
      if (itemgroup.hasScrollbar()) {
         this.blit(p_230450_1_, i, j + (int)((float)(k - j - 17) * this.currentScroll), 232 + (this.needsScrollBars() ? 0 : 12), 0, 12, 15);
      }
      ...
      if (itemgroup == ItemGroup.INVENTORY) {
         InventoryScreen.drawEntityOnScreen(this.guiLeft + 88, this.guiTop + 45, 20, (float)(this.guiLeft + 88 - p_230450_3_), (float)(this.guiTop + 45 - 30 - p_230450_4_), this.minecraft.player);
      }
