...
public class MultiplayerScreen extends Screen {
   ...
   public boolean keyPressed(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      if (super.keyPressed(p_231046_1_, p_231046_2_, p_231046_3_)) {
         ...
         if (p_231046_1_ != 257 && p_231046_1_ != 335) {
            return this.serverListSelector.keyPressed(p_231046_1_, p_231046_2_, p_231046_3_);
         } else {
            this.connectToSelected();
            return true;
         }
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.serverListSelector.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.drawCenteredString(p_230430_1_, this.font, this.title, this.width / 2, 20, 16777215);
      super.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      if (this.hoveringText != null) {
         this.renderTooltip(p_230430_1_, this.hoveringText, p_230430_2_, p_230430_3_);
      }
