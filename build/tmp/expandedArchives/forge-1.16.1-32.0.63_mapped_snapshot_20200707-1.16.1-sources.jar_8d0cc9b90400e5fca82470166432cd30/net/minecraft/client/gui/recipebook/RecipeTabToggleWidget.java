...
public class RecipeTabToggleWidget extends ToggleWidget {
   ...
   private void renderIcon(ItemRenderer p_193920_1_) {
      ...
      if (list.size() == 1) {
         p_193920_1_.func_239390_c_(list.get(0), this.x + 9 + i, this.y + 5);
      } else if (list.size() == 2) {
         p_193920_1_.func_239390_c_(list.get(0), this.x + 3 + i, this.y + 5);
         p_193920_1_.func_239390_c_(list.get(1), this.x + 14 + i, this.y + 5);
      }
