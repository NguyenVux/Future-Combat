...
public class AdvancementEntryGui extends AbstractGui {
   ...
   public AdvancementEntryGui(AdvancementTabGui p_i47385_1_, Minecraft p_i47385_2_, Advancement p_i47385_3_, DisplayInfo p_i47385_4_) {
      ...
      this.description = this.func_238694_a_(TextComponentUtils.func_240648_a_(p_i47385_4_.getDescription().deepCopy(), Style.EMPTY.setFormatting(p_i47385_4_.getFrame().getFormat())), l);
   ...
   private List<ITextProperties> func_238694_a_(ITextComponent p_238694_1_, int p_238694_2_) {
      ...
      for(int i : field_238687_b_) {
         List<ITextProperties> list1 = charactermanager.func_238362_b_(p_238694_1_, p_238694_2_ - i, Style.EMPTY);
   ...
   public void func_238688_a_(MatrixStack p_238688_1_, int p_238688_2_, int p_238688_3_) {
      if (!this.displayInfo.isHidden() || this.advancementProgress != null && this.advancementProgress.isDone()) {
         ...
         this.blit(p_238688_1_, p_238688_2_ + this.x + 3, p_238688_3_ + this.y, this.displayInfo.getFrame().getIcon(), 128 + advancementstate.getId() * 26, 26, 26);
   ...
   public void func_238689_a_(MatrixStack p_238689_1_, int p_238689_2_, int p_238689_3_, float p_238689_4_, int p_238689_5_, int p_238689_6_) {
      boolean flag = p_238689_5_ + p_238689_2_ + this.x + this.width + 26 >= this.guiAdvancementTab.getScreen().width;
      ...
      this.blit(p_238689_1_, i1, l, 0, advancementstate.getId() * 26, j, 26);
      this.blit(p_238689_1_, i1 + j, l, 200 - k, advancementstate1.getId() * 26, k, 26);
      this.blit(p_238689_1_, p_238689_2_ + this.x + 3, p_238689_3_ + this.y, this.displayInfo.getFrame().getIcon(), 128 + advancementstate2.getId() * 26, 26, 26);
      if (flag) {
         this.minecraft.fontRenderer.func_238407_a_(p_238689_1_, this.title, (float)(i1 + 5), (float)(p_238689_3_ + this.y + 9), -1);
         if (s != null) {
            this.minecraft.fontRenderer.drawStringWithShadow(p_238689_1_, s, (float)(p_238689_2_ + this.x - i), (float)(p_238689_3_ + this.y + 9), -1);
         }
      } else {
         ...
         if (s != null) {
            this.minecraft.fontRenderer.drawStringWithShadow(p_238689_1_, s, (float)(p_238689_2_ + this.x + this.width - i - 5), (float)(p_238689_3_ + this.y + 9), -1);
         }
      }
