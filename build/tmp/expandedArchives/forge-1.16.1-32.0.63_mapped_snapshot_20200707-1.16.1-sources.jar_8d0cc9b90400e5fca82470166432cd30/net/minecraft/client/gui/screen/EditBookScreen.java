...
public class EditBookScreen extends Screen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.font.drawString(p_230430_1_, s1, (float)(i + 36 + (114 - k) / 2), 34.0F, 0);
         int l = this.getTextWidth(s);
         this.font.drawString(p_230430_1_, s, (float)(i + 36 + (114 - l) / 2), 50.0F, 0);
         String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName().getString());
         int i1 = this.getTextWidth(s2);
         this.font.drawString(p_230430_1_, TextFormatting.DARK_GRAY + s2, (float)(i + 36 + (114 - i1) / 2), 60.0F, 0);
         ...
         this.font.drawString(p_230430_1_, s3, (float)(i - j1 + 192 - 44), 18.0F, 0);
         EditBookScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();

         for(EditBookScreen.BookLine editbookscreen$bookline : editbookscreen$bookpage.field_238784_f_) {
            this.font.func_238422_b_(p_230430_1_, editbookscreen$bookline.field_238797_c_, (float)editbookscreen$bookline.field_238798_d_, (float)editbookscreen$bookline.field_238799_e_, -16777216);
         }
   ...
   public boolean mouseClicked(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      if (super.mouseClicked(p_231044_1_, p_231044_3_, p_231044_5_)) {
         ...
         if (p_231044_5_ == 0) {
            ...
            EditBookScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();
            int j = editbookscreen$bookpage.func_238789_a_(this.font, this.func_238758_a_(new EditBookScreen.Point((int)p_231044_1_, (int)p_231044_3_)));
            if (j >= 0) {
