   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (this.isVisible()) {
         ...
         if (!this.searchBar.isFocused() && this.searchBar.getText().isEmpty()) {
            this.drawString(p_230430_1_, this.mc.fontRenderer, field_241620_l_, i + 25, j + 14, -1);
         } else {
            this.searchBar.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
         }
         ...
         this.toggleRecipesBtn.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
   ...
   public boolean mouseClicked(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      if (this.isVisible() && !this.mc.player.isSpectator()) {
         if (this.recipeBookPage.func_198955_a(p_231044_1_, p_231044_3_, p_231044_5_, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
            ...
            return true;
         } else if (this.searchBar.mouseClicked(p_231044_1_, p_231044_3_, p_231044_5_)) {
            return true;
         } else if (this.toggleRecipesBtn.mouseClicked(p_231044_1_, p_231044_3_, p_231044_5_)) {
   ...
   public boolean keyPressed(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      ...
      if (this.isVisible() && !this.mc.player.isSpectator()) {
         if (p_231046_1_ == 256 && !this.isOffsetNextToMainGUI()) {
            this.setVisible(false);
            return true;
         } else if (this.searchBar.keyPressed(p_231046_1_, p_231046_2_, p_231046_3_)) {
            this.updateSearch();
            return true;
         } else if (this.searchBar.isFocused() && this.searchBar.getVisible() && p_231046_1_ != 256) {
            return true;
         } else if (this.mc.gameSettings.keyBindChat.matchesKey(p_231046_1_, p_231046_2_) && !this.searchBar.isFocused()) {
