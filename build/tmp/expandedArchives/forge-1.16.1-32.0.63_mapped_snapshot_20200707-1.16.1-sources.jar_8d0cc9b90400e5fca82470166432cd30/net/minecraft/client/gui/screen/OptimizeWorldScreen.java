...
public class OptimizeWorldScreen extends Screen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      int l = k + 10;
      this.drawCenteredString(p_230430_1_, this.font, this.optimizer.getStatusText(), this.width / 2, k - 9 - 2, 10526880);
      if (this.optimizer.getTotalChunks() > 0) {
         fill(p_230430_1_, i - 1, k - 1, j + 1, l + 1, -16777216);
         this.drawString(p_230430_1_, this.font, I18n.format("optimizeWorld.info.converted", this.optimizer.getConverted()), i, 40, 10526880);
         this.drawString(p_230430_1_, this.font, I18n.format("optimizeWorld.info.skipped", this.optimizer.getSkipped()), i, 40 + 9 + 3, 10526880);
         this.drawString(p_230430_1_, this.font, I18n.format("optimizeWorld.info.total", this.optimizer.getTotalChunks()), i, 40 + (9 + 3) * 2, 10526880);
         int i1 = 0;
         ...
         for(RegistryKey<World> registrykey : this.optimizer.func_233533_c_()) {
            ...
            fill(p_230430_1_, i + i1, k, i + i1 + j1, l, PROGRESS_BAR_COLORS.getInt(registrykey));
            i1 += j1;
         }

         int k1 = this.optimizer.getConverted() + this.optimizer.getSkipped();
         this.drawCenteredString(p_230430_1_, this.font, k1 + " / " + this.optimizer.getTotalChunks(), this.width / 2, k + 2 * 9 + 2, 10526880);
         this.drawCenteredString(p_230430_1_, this.font, MathHelper.floor(this.optimizer.getTotalProgress() * 100.0F) + "%", this.width / 2, k + (l - k) / 2 - 9 / 2, 10526880);
      }
