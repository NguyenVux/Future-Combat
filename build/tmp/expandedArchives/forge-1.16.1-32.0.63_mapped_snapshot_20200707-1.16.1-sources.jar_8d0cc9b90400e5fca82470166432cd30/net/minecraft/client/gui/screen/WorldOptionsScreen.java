...
public class WorldOptionsScreen implements IScreen, IRenderable {
   ...
   public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_) {
      ...
      this.field_239034_h_ = p_239048_1_.addButton(new Button(i, 100, 150, 20, new TranslationTextComponent("selectWorld.mapFeatures"), (p_239056_1_) -> {
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().func_240702_b_(" ").func_230529_a_(DialogTexts.func_240638_a_(WorldOptionsScreen.this.field_239039_m_.func_236222_c_()));
         }

         protected IFormattableTextComponent getNarrationMessage() {
            return super.getNarrationMessage().func_240702_b_(". ").func_230529_a_(new TranslationTextComponent("selectWorld.mapFeatures.info"));
         }
      });
      ...
      this.field_239035_i_ = p_239048_1_.addButton(new Button(j, 100, 150, 20, new TranslationTextComponent("selectWorld.mapType"), (p_239050_2_) -> {
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().func_240702_b_(" ").func_230529_a_(WorldOptionsScreen.this.field_239040_n_.map(BiomeGeneratorTypeScreens::func_239077_a_).orElse(WorldOptionsScreen.field_239029_c_));
         }

         protected IFormattableTextComponent getNarrationMessage() {
            return Objects.equals(WorldOptionsScreen.this.field_239040_n_, Optional.of(BiomeGeneratorTypeScreens.field_239067_b_)) ? super.getNarrationMessage().func_240702_b_(". ").func_230529_a_(WorldOptionsScreen.field_239030_d_) : super.getNarrationMessage();
         }
      });
      ...
      this.field_239027_a_ = p_239048_1_.addButton(new Button(i, 151, 150, 20, new TranslationTextComponent("selectWorld.bonusItems"), (p_239047_1_) -> {
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().func_240702_b_(" ").func_230529_a_(DialogTexts.func_240638_a_(WorldOptionsScreen.this.field_239039_m_.func_236223_d_() && !p_239048_1_.hardCoreMode));
         }
      });
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (this.field_239034_h_.visible) {
         this.field_239031_e_.drawStringWithShadow(p_230430_1_, I18n.format("selectWorld.mapFeatures.info"), (float)(this.field_239032_f_ / 2 - 150), 122.0F, -6250336);
      }

      this.field_239033_g_.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
