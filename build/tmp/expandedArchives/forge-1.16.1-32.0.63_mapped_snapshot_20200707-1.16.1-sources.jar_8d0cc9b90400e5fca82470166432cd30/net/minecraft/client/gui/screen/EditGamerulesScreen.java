...
public class EditGamerulesScreen extends Screen {
   ...
   public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_238966_b_.render(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      ...
      if (this.field_238969_q_ != null) {
         this.renderTooltip(p_230430_1_, this.field_238969_q_, p_230430_2_, p_230430_3_);
      }
      ...
      public BooleanEntry(final ITextComponent p_i232311_2_, List<ITextProperties> p_i232311_3_, final String p_i232311_4_, final GameRules.BooleanValue p_i232311_5_) {
         ...
         this.field_238986_c_ = new Button(10, 5, 44, 20, DialogTexts.func_240638_a_(p_i232311_5_.get()), (p_238988_1_) -> {
            ...
            protected IFormattableTextComponent getNarrationMessage() {
               return BooleanEntry.this.func_238989_a_(p_i232311_2_, p_i232311_5_.get()).deepCopy().func_240702_b_("\n").func_240702_b_(p_i232311_4_);
            }
         };
   ...
   public class GamerulesList extends AbstractOptionList<EditGamerulesScreen.Gamerule> {
      public GamerulesList(final GameRules p_i232316_2_) {
         ...
         map.entrySet().stream().sorted(Map.Entry.comparingByKey()).forEach((p_239004_1_) -> {
            this.addEntry(EditGamerulesScreen.this.new NameEntry((new TranslationTextComponent(p_239004_1_.getKey().func_234908_a_())).func_240701_a_(new TextFormatting[]{TextFormatting.BOLD, TextFormatting.YELLOW})));
   ...
   public class IntegerEntry extends EditGamerulesScreen.ValueEntry {
      ...
      public IntegerEntry(ITextComponent p_i232314_2_, List<ITextProperties> p_i232314_3_, String p_i232314_4_, GameRules.IntegerValue p_i232314_5_) {
         ...
         this.field_238997_d_ = new TextFieldWidget(EditGamerulesScreen.this.minecraft.fontRenderer, 10, 5, 42, 20, p_i232314_2_.deepCopy().func_240702_b_("\n").func_240702_b_(p_i232314_4_).func_240702_b_("\n"));
