...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      if (this.minecraft.world != null) {
         ...
         this.difficultyButton = this.addButton(new Button(this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, this.func_238630_a_(this.field_213062_f), (p_213051_1_) -> {
            ...
            this.difficultyButton.setMessage(this.func_238630_a_(this.field_213062_f));
         }));
