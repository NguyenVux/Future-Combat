...
public class RangeCodec {
   ...
   public static <T> MapCodec<Pair<RegistryKey<T>, T>> func_241293_a_(RegistryKey<Registry<T>> p_241293_0_, MapCodec<T> p_241293_1_) {
      return Codec.mapPair(ResourceLocation.RESOURCE_LOCATION_CODEC.xmap(RegistryKey.func_240902_a_(p_241293_0_), RegistryKey::func_240901_a_).fieldOf("name"), p_241293_1_);
   }
