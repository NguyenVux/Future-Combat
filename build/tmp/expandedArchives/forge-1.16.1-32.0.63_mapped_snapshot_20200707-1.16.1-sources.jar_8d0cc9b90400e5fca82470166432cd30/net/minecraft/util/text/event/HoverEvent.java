...
public class HoverEvent {
   ...
   public <T> HoverEvent(HoverEvent.Action<T> actionIn, T valueIn) {
   ...
   @Nullable
   public static HoverEvent deserialize(JsonObject jsonIn) {
      String s = JSONUtils.getString(jsonIn, "action", (String)null);
      if (s == null) {
         return null;
      } else {
         ...
         if (action == null) {
            ...
            JsonElement jsonelement = jsonIn.get("contents");
            if (jsonelement != null) {
               return action.func_240668_a_(jsonelement);
            } else {
               ITextComponent itextcomponent = ITextComponent.Serializer.func_240641_a_(jsonIn.get("value"));
   ...
   public static class Action<T> {
      ...
      public static final HoverEvent.Action<HoverEvent.EntityHover> SHOW_ENTITY = new HoverEvent.Action<>("show_entity", true, HoverEvent.EntityHover::func_240682_a_, HoverEvent.EntityHover::func_240681_a_, HoverEvent.EntityHover::func_240683_a_);
