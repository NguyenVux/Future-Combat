...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   private static DataResult<ResourceLocation> decodeResourceLocation(String encodedIn) {
      try {
         return DataResult.success(new ResourceLocation(encodedIn));
      } catch (ResourceLocationException resourcelocationexception) {
         return DataResult.error("Not a valid resource location: " + encodedIn + " " + resourcelocationexception.getMessage());
      }
   }
   ...
   private static boolean validatePathChar(char charIn) {
      return charIn == '_' || charIn == '-' || charIn >= 'a' && charIn <= 'z' || charIn >= '0' && charIn <= '9' || charIn == '/' || charIn == '.';
   }

   private static boolean validateNamespaceChar(char charIn) {
