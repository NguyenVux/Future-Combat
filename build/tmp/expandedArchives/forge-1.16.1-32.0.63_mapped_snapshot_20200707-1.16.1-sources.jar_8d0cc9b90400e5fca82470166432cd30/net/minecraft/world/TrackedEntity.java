...
public class TrackedEntity {
   ...
   public void sendSpawnPackets(Consumer<IPacket<?>> p_219452_1_) {
      ...
      if (this.trackedEntity instanceof LivingEntity) {
         Collection<ModifiableAttributeInstance> collection = ((LivingEntity)this.trackedEntity).getAttributeManager().func_233789_b_();
   ...
   private void sendMetadata() {
      ...
      if (this.trackedEntity instanceof LivingEntity) {
         Set<ModifiableAttributeInstance> set = ((LivingEntity)this.trackedEntity).getAttributeManager().func_233778_a_();
         if (!set.isEmpty()) {
