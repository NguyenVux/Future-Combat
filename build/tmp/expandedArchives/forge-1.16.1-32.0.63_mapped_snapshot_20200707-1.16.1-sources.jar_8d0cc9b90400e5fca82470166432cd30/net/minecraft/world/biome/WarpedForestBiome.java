...
public class WarpedForestBiome extends Biome {
   protected WarpedForestBiome() {
      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.field_237189_ad_, SurfaceBuilder.field_237186_Q_).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).func_235246_b_(4159204).func_235248_c_(329011).func_235239_a_(1705242).func_235244_a_(new ParticleEffectAmbience(ParticleTypes.WARPED_SPORE, 0.01428F)).func_235241_a_(SoundEvents.AMBIENT_WARPED_FOREST_LOOP).func_235243_a_(new MoodSoundAmbience(SoundEvents.AMBIENT_WARPED_FOREST_MOOD, 6000, 8, 2.0D)).func_235242_a_(new SoundAdditionsAmbience(SoundEvents.AMBIENT_WARPED_FOREST_ADDITIONS, 0.0111D)).func_235240_a_(BackgroundMusicTracks.func_232677_a_(SoundEvents.MUSIC_NETHER_WARPED_FOREST)).func_235238_a_()).parent((String)null).func_235098_a_(ImmutableList.of(new Biome.Attributes(0.0F, 0.5F, 0.0F, 0.0F, 0.375F))));
