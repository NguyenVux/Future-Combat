...
public class DefaultBiomeFeatures {
   ...
   private static final BlockState field_235153_cd_ = Blocks.SOUL_FIRE.getDefaultState();
   private static final BlockState NETHERRACK = Blocks.NETHERRACK.getDefaultState();
   private static final BlockState field_235154_cf_ = Blocks.SOUL_SOIL.getDefaultState();
   private static final BlockState field_235155_cg_ = Blocks.CRIMSON_ROOTS.getDefaultState();
   ...
   private static final BlockState field_235156_cq_ = Blocks.NETHER_GOLD_ORE.getDefaultState();
   private static final BlockState field_235157_cr_ = Blocks.NETHER_QUARTZ_ORE.getDefaultState();
   private static final BlockState field_235158_cs_ = Blocks.WARPED_STEM.getDefaultState();
   private static final BlockState field_235159_ct_ = Blocks.WARPED_WART_BLOCK.getDefaultState();
   private static final BlockState field_235160_cu_ = Blocks.NETHER_WART_BLOCK.getDefaultState();
   private static final BlockState field_235161_cv_ = Blocks.CRIMSON_STEM.getDefaultState();
   private static final BlockState field_235162_cw_ = Blocks.SHROOMLIGHT.getDefaultState();
   ...
   public static final LiquidsConfig field_235137_aN_ = new LiquidsConfig(field_235136_aJ_, true, 4, 1, ImmutableSet.of(Blocks.NETHERRACK, Blocks.SOUL_SAND, Blocks.GRAVEL, Blocks.MAGMA_BLOCK, Blocks.BLACKSTONE));
   ...
   public static final BlockStateProvidingFeatureConfig field_235151_ba_ = new BlockStateProvidingFeatureConfig(new SimpleBlockStateProvider(Blocks.NETHER_SPROUTS.getDefaultState()));
