...
public class Biome extends net.minecraftforge.registries.ForgeRegistryEntry<Biome> {
   ...
   public static final Codec<Biome> field_235051_b_ = RecordCodecBuilder.create((p_235064_0_) -> {
      ...
      }), Codec.simpleMap(EntityClassification.field_233667_g_, Biome.SpawnListEntry.field_235123_b_.listOf().promotePartial(Util.func_240982_a_("Spawn data: ", LOGGER::error)), IStringSerializable.createKeyable(EntityClassification.values())).fieldOf("spawners").forGetter((p_235073_0_) -> {
   ...
   /**
    * Gets the current temperature at the given location
    */
   ...
   public static enum RainType implements IStringSerializable {
      ...
      public static final Codec<Biome.RainType> field_235121_d_ = IStringSerializable.createEnumCodec(Biome.RainType::values, Biome.RainType::func_235122_a_);
