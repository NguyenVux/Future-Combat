...
public class VillageConfig implements IFeatureConfig {
   public static final Codec<VillageConfig> field_236533_a_ = RecordCodecBuilder.create((p_236535_0_) -> {
      return p_236535_0_.group(ResourceLocation.RESOURCE_LOCATION_CODEC.fieldOf("start_pool").forGetter(VillageConfig::func_236536_b_), Codec.INT.fieldOf("size").forGetter(VillageConfig::func_236534_a_)).apply(p_236535_0_, VillageConfig::new);
   });
