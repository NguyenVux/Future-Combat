      ...
      for(int i = 1; i <= p_236422_3_; ++i) {
         if (p_236422_0_.isAirBlock(p_236422_2_)) {
            if (i == p_236422_3_ || !p_236422_0_.isAirBlock(p_236422_2_.up())) {
               p_236422_0_.setBlockState(p_236422_2_, Blocks.TWISTING_VINES.getDefaultState().with(AbstractTopPlantBlock.field_235502_d_, Integer.valueOf(MathHelper.nextInt(p_236422_1_, p_236422_4_, p_236422_5_))), 2);
               break;
            }
