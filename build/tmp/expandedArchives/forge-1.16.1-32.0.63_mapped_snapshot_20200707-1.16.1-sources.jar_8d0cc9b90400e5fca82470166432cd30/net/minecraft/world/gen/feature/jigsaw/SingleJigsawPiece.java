...
public class SingleJigsawPiece extends JigsawPiece {
   private static final Codec<Either<ResourceLocation, Template>> field_236837_a_ = Codec.of(SingleJigsawPiece::func_236840_a_, ResourceLocation.RESOURCE_LOCATION_CODEC.map(Either::left));
   ...
   private static <T> DataResult<T> func_236840_a_(Either<ResourceLocation, Template> p_236840_0_, DynamicOps<T> p_236840_1_, T p_236840_2_) {
      ...
      return !optional.isPresent() ? DataResult.error("Can not serialize a runtime pool element") : ResourceLocation.RESOURCE_LOCATION_CODEC.encode(optional.get(), p_236840_1_, p_236840_2_);
   }
