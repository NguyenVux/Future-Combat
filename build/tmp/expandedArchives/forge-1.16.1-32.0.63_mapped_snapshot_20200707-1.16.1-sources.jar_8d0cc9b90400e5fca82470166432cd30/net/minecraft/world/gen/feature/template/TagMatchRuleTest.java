...
public class TagMatchRuleTest extends RuleTest {
   public static final Codec<TagMatchRuleTest> field_237161_a_ = ITag.getTagCodec(TagCollectionManager.func_232928_e_()::func_232923_a_).fieldOf("tag").xmap(TagMatchRuleTest::new, (p_237162_0_) -> {
