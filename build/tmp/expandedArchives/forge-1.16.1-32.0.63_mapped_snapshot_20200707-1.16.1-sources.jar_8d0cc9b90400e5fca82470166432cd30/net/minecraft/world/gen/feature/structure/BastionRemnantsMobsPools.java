...
public class BastionRemnantsMobsPools {
   public static final RuleEntry field_236260_a_ = new RuleEntry(new RandomBlockMatchRuleTest(Blocks.BLACKSTONE, 0.01F), AlwaysTrueRuleTest.INSTANCE, Blocks.GILDED_BLACKSTONE.getDefaultState());
