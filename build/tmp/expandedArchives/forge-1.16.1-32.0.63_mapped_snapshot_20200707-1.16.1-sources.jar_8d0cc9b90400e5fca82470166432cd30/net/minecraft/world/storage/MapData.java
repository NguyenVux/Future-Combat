...
public class MapData extends WorldSavedData {
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ResourceLocation.RESOURCE_LOCATION_CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.dimension.func_240901_a_()).resultOrPartial(field_237240_k_::error).ifPresent((p_237242_1_) -> {
