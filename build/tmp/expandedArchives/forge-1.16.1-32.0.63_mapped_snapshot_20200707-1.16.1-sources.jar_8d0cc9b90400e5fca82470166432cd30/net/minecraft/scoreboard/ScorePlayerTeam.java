...
public class ScorePlayerTeam extends Team {
   ...
   public IFormattableTextComponent func_237501_d_() {
      IFormattableTextComponent iformattabletextcomponent = TextComponentUtils.func_240647_a_(this.displayName.deepCopy().func_240703_c_(this.field_237499_m_));
    ...
    * usage; it does _not_ affect all situations (for instance
    */
