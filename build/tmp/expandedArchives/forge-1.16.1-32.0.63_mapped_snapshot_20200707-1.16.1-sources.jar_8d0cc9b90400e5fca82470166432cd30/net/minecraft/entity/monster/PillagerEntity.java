...
public class PillagerEntity extends AbstractIllagerEntity implements ICrossbowUser {
   ...
   public static AttributeModifierMap.MutableAttribute func_234296_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.35F).func_233815_a_(Attributes.MAX_HEALTH, 24.0D).func_233815_a_(Attributes.ATTACK_DAMAGE, 5.0D).func_233815_a_(Attributes.FOLLOW_RANGE, 32.0D);
   }
