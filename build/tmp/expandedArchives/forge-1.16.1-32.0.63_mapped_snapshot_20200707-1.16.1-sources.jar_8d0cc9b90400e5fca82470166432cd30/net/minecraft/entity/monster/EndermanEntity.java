...
public class EndermanEntity extends MonsterEntity implements IAngerable {
   ...
   public static AttributeModifierMap.MutableAttribute func_234287_m_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MAX_HEALTH, 40.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.ATTACK_DAMAGE, 7.0D).func_233815_a_(Attributes.FOLLOW_RANGE, 64.0D);
   }
