...
public class EndermiteEntity extends MonsterEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234288_m_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MAX_HEALTH, 8.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, 0.25D).func_233815_a_(Attributes.ATTACK_DAMAGE, 2.0D);
   }
