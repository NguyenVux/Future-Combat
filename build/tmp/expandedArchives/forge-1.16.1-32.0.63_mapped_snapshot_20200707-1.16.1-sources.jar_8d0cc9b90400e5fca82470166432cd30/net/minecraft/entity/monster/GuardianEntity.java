...
public class GuardianEntity extends MonsterEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234292_eK_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.ATTACK_DAMAGE, 6.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, 0.5D).func_233815_a_(Attributes.FOLLOW_RANGE, 16.0D).func_233815_a_(Attributes.MAX_HEALTH, 30.0D);
   }
      ...
      public void tick() {
         ...
         if (!this.guardian.canEntityBeSeen(livingentity)) {
            ...
            if (this.tickCounter == 0) {
               ...
               livingentity.attackEntityFrom(DamageSource.causeMobDamage(this.guardian), (float)this.guardian.func_233637_b_(Attributes.ATTACK_DAMAGE));
               this.guardian.setAttackTarget((LivingEntity)null);
            }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         if (this.action == MovementController.Action.MOVE_TO && !this.entityGuardian.getNavigator().noPath()) {
            ...
            float f1 = (float)(this.speed * this.entityGuardian.func_233637_b_(Attributes.MOVEMENT_SPEED));
