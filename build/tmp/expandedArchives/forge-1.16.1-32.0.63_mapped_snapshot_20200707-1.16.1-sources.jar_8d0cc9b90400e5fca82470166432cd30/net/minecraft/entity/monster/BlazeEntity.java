...
public class BlazeEntity extends MonsterEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234276_m_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.ATTACK_DAMAGE, 6.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.23F).func_233815_a_(Attributes.FOLLOW_RANGE, 48.0D);
   }
   ...
   static class FireballAttackGoal extends Goal {
      ...
      private double getFollowDistance() {
         return this.blaze.func_233637_b_(Attributes.FOLLOW_RANGE);
      }
   }
}