...
public class ElderGuardianEntity extends GuardianEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234283_m_() {
      return GuardianEntity.func_234292_eK_().func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.ATTACK_DAMAGE, 8.0D).func_233815_a_(Attributes.MAX_HEALTH, 80.0D);
   }
