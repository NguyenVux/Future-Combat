...
public class HoglinEntity extends AnimalEntity implements IMob, IFlinging {
   ...
   public static AttributeModifierMap.MutableAttribute func_234362_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MAX_HEALTH, 40.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.KNOCKBACK_RESISTANCE, (double)0.6F).func_233815_a_(Attributes.ATTACK_KNOCKBACK, 1.0D).func_233815_a_(Attributes.ATTACK_DAMAGE, 6.0D);
   }
