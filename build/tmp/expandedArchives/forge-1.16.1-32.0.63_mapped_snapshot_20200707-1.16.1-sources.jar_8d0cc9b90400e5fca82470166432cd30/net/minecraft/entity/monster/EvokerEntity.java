...
public class EvokerEntity extends SpellcastingIllagerEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234289_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MOVEMENT_SPEED, 0.5D).func_233815_a_(Attributes.FOLLOW_RANGE, 12.0D).func_233815_a_(Attributes.MAX_HEALTH, 24.0D);
   }
