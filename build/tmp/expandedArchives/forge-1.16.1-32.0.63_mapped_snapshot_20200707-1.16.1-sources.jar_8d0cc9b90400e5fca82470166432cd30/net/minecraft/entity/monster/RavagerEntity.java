...
public class RavagerEntity extends AbstractRaiderEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234297_m_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MAX_HEALTH, 100.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, 0.3D).func_233815_a_(Attributes.KNOCKBACK_RESISTANCE, 0.75D).func_233815_a_(Attributes.ATTACK_DAMAGE, 12.0D).func_233815_a_(Attributes.ATTACK_KNOCKBACK, 1.5D).func_233815_a_(Attributes.FOLLOW_RANGE, 32.0D);
   }
