...
public class IllusionerEntity extends SpellcastingIllagerEntity implements IRangedAttackMob {
   ...
   public static AttributeModifierMap.MutableAttribute func_234293_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.MOVEMENT_SPEED, 0.5D).func_233815_a_(Attributes.FOLLOW_RANGE, 18.0D).func_233815_a_(Attributes.MAX_HEALTH, 32.0D);
   }
