...
public class ZombifiedPiglinEntity extends ZombieEntity implements IAngerable {
   ...
   public static AttributeModifierMap.MutableAttribute func_234352_eU_() {
      return ZombieEntity.func_234342_eQ_().func_233815_a_(Attributes.ZOMBIE_SPAWN_REINFORCEMENTS, 0.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.23F).func_233815_a_(Attributes.ATTACK_DAMAGE, 5.0D);
   }
   ...
   private void func_241411_fa_() {
      double d0 = this.func_233637_b_(Attributes.FOLLOW_RANGE);
