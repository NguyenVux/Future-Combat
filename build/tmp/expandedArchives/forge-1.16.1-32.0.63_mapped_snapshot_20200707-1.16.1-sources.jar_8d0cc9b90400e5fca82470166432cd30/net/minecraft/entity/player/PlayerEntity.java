...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234570_el_() {
      return LivingEntity.registerAttributes().func_233815_a_(Attributes.ATTACK_DAMAGE, 1.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.1F).func_233814_a_(Attributes.ATTACK_SPEED).func_233814_a_(Attributes.LUCK).func_233814_a_(net.minecraftforge.common.ForgeMod.REACH_DISTANCE.get());
   }
   ...
   /**
    * Creates and drops the provided item. Depending on the dropAround
    */
   @Nullable
   ...
   protected void damageArmor(DamageSource damageSourceIn, float damageIn) {
      this.inventory.func_234563_a_(damageSourceIn, damageIn);
   }
   ...
   public float getAIMoveSpeed() {
      return (float)this.func_233637_b_(Attributes.MOVEMENT_SPEED);
   }
   ...
   public float getCooldownPeriod() {
      return (float)(1.0D / this.func_233637_b_(Attributes.ATTACK_SPEED) * 20.0D);
   }
   ...
   public float getLuck() {
      return (float)this.func_233637_b_(Attributes.LUCK);
   }
