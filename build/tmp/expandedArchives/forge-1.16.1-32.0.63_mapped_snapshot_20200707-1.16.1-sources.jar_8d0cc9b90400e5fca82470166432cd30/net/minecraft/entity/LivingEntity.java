...
public abstract class LivingEntity extends Entity {
   ...
   public static AttributeModifierMap.MutableAttribute registerAttributes() {
      return AttributeModifierMap.func_233803_a_().func_233814_a_(Attributes.MAX_HEALTH).func_233814_a_(Attributes.KNOCKBACK_RESISTANCE).func_233814_a_(Attributes.MOVEMENT_SPEED).func_233814_a_(Attributes.ARMOR).func_233814_a_(Attributes.ARMOR_TOUGHNESS).func_233814_a_(net.minecraftforge.common.ForgeMod.SWIM_SPEED.get()).func_233814_a_(net.minecraftforge.common.ForgeMod.NAMETAG_DISTANCE.get()).func_233814_a_(net.minecraftforge.common.ForgeMod.ENTITY_GRAVITY.get());
   }
   ...
   protected boolean func_230296_cM_() {
      return this.func_233568_aJ_().isIn(BlockTags.SOUL_SPEED_BLOCKS);
   }
   ...
   protected void func_233642_cO_() {
      if (!this.func_233568_aJ_().isAir()) {
         ...
         if (i > 0 && this.func_230296_cM_()) {
            ...
            modifiableattributeinstance.func_233767_b_(new AttributeModifier(SOUL_SPEED_BOOT_ID, "Soul speed boost", (double)(0.03F * (1.0F + (float)i * 0.35F)), AttributeModifier.Operation.ADDITION));
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.put("Attributes", this.getAttributeManager().func_233794_c_());
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Attributes", 9) && this.world != null && !this.world.isRemote) {
         this.getAttributeManager().func_233788_a_(compound.getList("Attributes", 10));
      }
   ...
   /**
    * Determines whether the entity can block the damage source based on the damage source's location
    */
   ...
   protected void createWitherRose(@Nullable LivingEntity entitySourceIn) {
      if (!this.world.isRemote) {
         boolean flag = false;
         if (entitySourceIn instanceof WitherEntity) {
   ...
   protected void dropLoot(DamageSource damageSourceIn, boolean attackedRecentlyIn) {
      ...
      LootContext.Builder lootcontext$builder = this.getLootContextBuilder(attackedRecentlyIn, damageSourceIn);
      LootContext ctx = lootcontext$builder.build(LootParameterSets.ENTITY);
      loottable.generate(ctx).forEach(this::entityDropItem);
   }

   protected LootContext.Builder getLootContextBuilder(boolean attackedRecentlyIn, DamageSource damageSourceIn) {
      ...
      if (attackedRecentlyIn && this.attackingPlayer != null) {
   ...
   public void applyKnockback(float strengthIn, double ratioXIn, double ratioZIn) {
      ...
      net.minecraftforge.event.entity.living.LivingKnockBackEvent event = net.minecraftforge.common.ForgeHooks.onLivingKnockBack(this, null, strengthIn, ratioXIn, ratioZIn);
      if(event.isCanceled()) return;
      strengthIn = event.getStrength();
      ratioXIn = event.getRatioX();
      ratioZIn = event.getRatioZ();
      strengthIn = (float)((double)strengthIn * (1.0D - this.func_233637_b_(Attributes.KNOCKBACK_RESISTANCE)));
      if (!(strengthIn <= 0.0F)) {
         this.isAirBorne = true;
         Vector3d vector3d = this.getMotion();
         Vector3d vector3d1 = (new Vector3d(ratioXIn, 0.0D, ratioZIn)).normalize().scale((double)strengthIn);
         this.setMotion(vector3d.x / 2.0D - vector3d1.x, this.onGround ? Math.min(0.4D, vector3d.y / 2.0D + (double)strengthIn) : vector3d.y, vector3d.z / 2.0D - vector3d1.z);
      }
   }
   ...
   /**
    * Returns true if this entity should move as if it were on a ladder (either because it's actually on a ladder
    */
   ...
   protected int calculateFallDamage(float distanceIn, float damageMultiplierIn) {
      ...
      return MathHelper.ceil((distanceIn - 3.0F - f) * damageMultiplierIn);
   }
   ...
   public int getTotalArmorValue() {
      return MathHelper.floor(this.func_233637_b_(Attributes.ARMOR));
   }

   protected void damageArmor(DamageSource damageSourceIn, float damageIn) {
   }
   ...
   protected float applyArmorCalculations(DamageSource source, float damage) {
      if (!source.isUnblockable()) {
         ...
         damage = CombatRules.getDamageAfterAbsorb(damage, (float)this.getTotalArmorValue(), (float)this.func_233637_b_(Attributes.ARMOR_TOUGHNESS));
      }
   ...
   /**
    * Returns the maximum health of the entity (what it is able to regenerate up to
    */
   public final float getMaxHealth() {
      return (float)this.func_233637_b_(Attributes.MAX_HEALTH);
   }
   ...
   public ModifiableAttributeInstance getAttribute(Attribute attribute) {
      return this.getAttributeManager().func_233779_a_(attribute);
   }

   public double func_233637_b_(Attribute attributeIn) {
      return this.getAttributeManager().func_233795_c_(attributeIn);
   }

   public double func_233638_c_(Attribute attributeIn) {
      return this.getAttributeManager().func_233797_d_(attributeIn);
   }
   ...
   public boolean func_233631_a_(Item itemIn) {
      return this.func_233634_a_((p_233632_1_) -> {
         return p_233632_1_ == itemIn;
      });
   }
   ...
   /**
    * Applies a velocity to the entities
    */
   ...
   private Map<EquipmentSlotType, ItemStack> func_241354_r_() {
      ...
      for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
         ...
         if (!ItemStack.areItemStacksEqual(itemstack1, itemstack)) {
            ...
            if (!itemstack.isEmpty()) {
               this.getAttributeManager().func_233785_a_(itemstack.getAttributeModifiers(equipmentslottype));
            }

            if (!itemstack1.isEmpty()) {
               this.getAttributeManager().func_233793_b_(itemstack1.getAttributeModifiers(equipmentslottype));
            }
         }
      }
   ...
   private ItemStack getArmorInSlot(EquipmentSlotType slotIn) {
      return this.armorArray.get(slotIn.getIndex());
   }

   private void setArmorInSlot(EquipmentSlotType slotIn, ItemStack stackIn) {
      this.armorArray.set(slotIn.getIndex(), stackIn);
   }

   private ItemStack getItemInHand(EquipmentSlotType slotIn) {
      return this.handInventory.get(slotIn.getIndex());
   }

   private void setItemInHand(EquipmentSlotType slotIn, ItemStack stackIn) {
      this.handInventory.set(slotIn.getIndex(), stackIn);
   }
   ...
   public void triggerItemPickupTrigger(ItemEntity itemIn) {
      PlayerEntity playerentity = itemIn.getThrowerId() != null ? this.world.getPlayerByUuid(itemIn.getThrowerId()) : null;
      if (playerentity instanceof ServerPlayerEntity) {
         CriteriaTriggers.field_232609_O_.func_234830_a_((ServerPlayerEntity)playerentity, itemIn.getItem(), this);
      }
   ...
   /**
    * Gets the progression of the swing animation
    */
   @OnlyIn(Dist.CLIENT)
   ...
   /**
    * Marks this entity's velocity as changed
    */
   protected void markVelocityChanged() {
      this.velocityChanged = this.rand.nextDouble() >= this.func_233637_b_(Attributes.KNOCKBACK_RESISTANCE);
   }
   ...
   protected void triggerItemUseEffects(ItemStack stackIn, int countIn) {
      if (!stackIn.isEmpty() && this.isHandActive()) {
         if (stackIn.getUseAction() == UseAction.DRINK) {
            this.playSound(this.getDrinkSound(stackIn), 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
         }

         if (stackIn.getUseAction() == UseAction.EAT) {
            this.addItemParticles(stackIn, countIn);
            this.playSound(this.getEatSound(stackIn), 0.5F + 0.5F * (float)this.rand.nextInt(2), (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
         }
   ...
   public AxisAlignedBB getPoseAABB(Pose poseIn) {
      EntitySize entitysize = this.getSize(poseIn);
