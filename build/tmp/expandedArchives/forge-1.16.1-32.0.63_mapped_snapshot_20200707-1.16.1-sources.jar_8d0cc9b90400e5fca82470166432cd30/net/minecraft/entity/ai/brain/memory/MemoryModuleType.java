...
public class MemoryModuleType<U> extends net.minecraftforge.registries.ForgeRegistryEntry<MemoryModuleType<?>> {
   ...
   public static final MemoryModuleType<Long> field_226332_A_ = registerWithCodec("last_woken", Codec.LONG);
   ...
   public static final MemoryModuleType<UUID> ANGRY_AT = registerWithCodec("angry_at", UUIDCodec.field_239775_a_);
   ...
   private static <U> MemoryModuleType<U> registerWithCodec(String identifierIn, Codec<U> codecIn) {
      return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(identifierIn), new MemoryModuleType<>(Optional.of(codecIn)));
   }

   private static <U> MemoryModuleType<U> register(String identifierIn) {
      return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(identifierIn), new MemoryModuleType<>(Optional.empty()));
   }
}