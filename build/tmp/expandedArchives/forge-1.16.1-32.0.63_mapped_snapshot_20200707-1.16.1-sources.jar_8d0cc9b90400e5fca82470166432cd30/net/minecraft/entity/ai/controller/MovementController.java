...
public class MovementController {
   ...
   public void tick() {
      if (this.action == MovementController.Action.STRAFE) {
         float f = (float)this.mob.func_233637_b_(Attributes.MOVEMENT_SPEED);
         ...
         this.mob.setAIMoveSpeed((float)(this.speed * this.mob.func_233637_b_(Attributes.MOVEMENT_SPEED)));
   ...
   /**
    * Attempt to rotate the first angle to become the second angle
    */
