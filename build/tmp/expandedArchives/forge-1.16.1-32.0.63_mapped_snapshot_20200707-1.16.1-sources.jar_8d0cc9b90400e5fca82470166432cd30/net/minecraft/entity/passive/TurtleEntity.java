...
public class TurtleEntity extends AnimalEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234228_eK_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 30.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, 0.25D);
   }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.action == MovementController.Action.MOVE_TO && !this.turtle.getNavigator().noPath()) {
            ...
            float f1 = (float)(this.speed * this.turtle.func_233637_b_(Attributes.MOVEMENT_SPEED));
