...
public class DolphinEntity extends WaterMobEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234190_eK_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 10.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)1.2F).func_233815_a_(Attributes.ATTACK_DAMAGE, 3.0D);
   }
      ...
      public void tick() {
         ...
         if (this.action == MovementController.Action.MOVE_TO && !this.dolphin.getNavigator().noPath()) {
            ...
            if (d3 < (double)2.5000003E-7F) {
               ...
               float f1 = (float)(this.speed * this.dolphin.func_233637_b_(Attributes.MOVEMENT_SPEED));
               if (this.dolphin.isInWater()) {
