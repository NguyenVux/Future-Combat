...
public class FoxEntity extends AnimalEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234192_eI_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.MAX_HEALTH, 10.0D).func_233815_a_(Attributes.FOLLOW_RANGE, 32.0D).func_233815_a_(Attributes.ATTACK_DAMAGE, 2.0D);
   }
   ...
   protected int calculateFallDamage(float distanceIn, float damageMultiplierIn) {
      return MathHelper.ceil((distanceIn - 5.0F) * damageMultiplierIn);
   }
