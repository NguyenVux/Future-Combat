...
public class PolarBearEntity extends AnimalEntity implements IAngerable {
   ...
   public static AttributeModifierMap.MutableAttribute func_234219_eI_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 30.0D).func_233815_a_(Attributes.FOLLOW_RANGE, 20.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, 0.25D).func_233815_a_(Attributes.ATTACK_DAMAGE, 6.0D);
   }
