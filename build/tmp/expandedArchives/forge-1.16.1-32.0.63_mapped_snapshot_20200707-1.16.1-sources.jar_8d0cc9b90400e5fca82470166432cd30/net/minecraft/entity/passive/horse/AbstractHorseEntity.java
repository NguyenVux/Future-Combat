...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount, IEquipable {
   ...
   protected int calculateFallDamage(float distanceIn, float damageMultiplierIn) {
      return MathHelper.ceil((distanceIn * 0.5F - 3.0F) * damageMultiplierIn);
   }
   ...
   public double getHorseJumpStrength() {
      return this.func_233637_b_(Attributes.HORSE_JUMP_STRENGTH);
   }
   ...
   public static AttributeModifierMap.MutableAttribute func_234237_fg_() {
      return MobEntity.func_233666_p_().func_233814_a_(Attributes.HORSE_JUMP_STRENGTH).func_233815_a_(Attributes.MAX_HEALTH, 53.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.225F);
   }
      ...
      if (this.isAlive()) {
         if (this.isBeingRidden() && this.canBeSteered() && this.isHorseSaddled()) {
            ...
            if (this.canPassengerSteer()) {
               this.setAIMoveSpeed((float)this.func_233637_b_(Attributes.MOVEMENT_SPEED));
   ...
   protected void setOffspringAttributes(AgeableEntity p_190681_1_, AbstractHorseEntity p_190681_2_) {
      double d0 = this.func_233638_c_(Attributes.MAX_HEALTH) + p_190681_1_.func_233638_c_(Attributes.MAX_HEALTH) + (double)this.getModifiedMaxHealth();
      p_190681_2_.getAttribute(Attributes.MAX_HEALTH).setBaseValue(d0 / 3.0D);
      double d1 = this.func_233638_c_(Attributes.HORSE_JUMP_STRENGTH) + p_190681_1_.func_233638_c_(Attributes.HORSE_JUMP_STRENGTH) + this.getModifiedJumpStrength();
      p_190681_2_.getAttribute(Attributes.HORSE_JUMP_STRENGTH).setBaseValue(d1 / 3.0D);
      double d2 = this.func_233638_c_(Attributes.MOVEMENT_SPEED) + p_190681_1_.func_233638_c_(Attributes.MOVEMENT_SPEED) + this.getModifiedMovementSpeed();
