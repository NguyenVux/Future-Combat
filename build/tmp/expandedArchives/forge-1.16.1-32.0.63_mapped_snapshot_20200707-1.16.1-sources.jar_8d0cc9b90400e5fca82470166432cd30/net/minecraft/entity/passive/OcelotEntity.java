...
public class OcelotEntity extends AnimalEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234201_eI_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 10.0D).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.ATTACK_DAMAGE, 3.0D);
   }
