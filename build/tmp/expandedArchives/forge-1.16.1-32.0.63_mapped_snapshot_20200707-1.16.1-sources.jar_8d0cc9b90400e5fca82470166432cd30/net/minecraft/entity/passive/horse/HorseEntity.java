   ...
   private void func_213804_l(ItemStack p_213804_1_) {
      ...
      if (!this.world.isRemote) {
         ...
         if (this.isArmor(p_213804_1_)) {
            ...
            if (i != 0) {
               this.getAttribute(Attributes.ARMOR).func_233767_b_(new AttributeModifier(ARMOR_MODIFIER_UUID, "Horse armor bonus", (double)i, AttributeModifier.Operation.ADDITION));
            }
         }
      }
