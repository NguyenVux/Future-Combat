...
public class BeeEntity extends AnimalEntity implements IAngerable, IFlyingAnimal {
   ...
   public boolean attackEntityAsMob(Entity entityIn) {
      boolean flag = entityIn.attackEntityFrom(DamageSource.func_226252_a_(this), (float)((int)this.func_233637_b_(Attributes.ATTACK_DAMAGE)));
      if (flag) {
   ...
   public static AttributeModifierMap.MutableAttribute func_234182_eX_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 10.0D).func_233815_a_(Attributes.FLYING_SPEED, (double)0.6F).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.ATTACK_DAMAGE, 2.0D).func_233815_a_(Attributes.FOLLOW_RANGE, 48.0D);
   }
