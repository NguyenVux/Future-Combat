...
public class WolfEntity extends TameableEntity implements IAngerable {
   ...
   public static AttributeModifierMap.MutableAttribute func_234233_eS_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.3F).func_233815_a_(Attributes.MAX_HEALTH, 8.0D).func_233815_a_(Attributes.ATTACK_DAMAGE, 2.0D);
   }
