...
public class ParrotEntity extends ShoulderRidingEntity implements IFlyingAnimal {
   ...
   public static AttributeModifierMap.MutableAttribute func_234213_eS_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 6.0D).func_233815_a_(Attributes.FLYING_SPEED, (double)0.4F).func_233815_a_(Attributes.MOVEMENT_SPEED, (double)0.2F);
   }
