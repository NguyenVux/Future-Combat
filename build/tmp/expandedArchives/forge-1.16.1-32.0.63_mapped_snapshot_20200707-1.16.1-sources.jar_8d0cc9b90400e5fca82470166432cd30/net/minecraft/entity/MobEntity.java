...
public abstract class MobEntity extends LivingEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_233666_p_() {
      return LivingEntity.registerAttributes().func_233815_a_(Attributes.FOLLOW_RANGE, 16.0D).func_233814_a_(Attributes.ATTACK_KNOCKBACK);
   }
   ...
   protected void dropLoot(DamageSource damageSourceIn, boolean attackedRecentlyIn) {
      super.dropLoot(damageSourceIn, attackedRecentlyIn);
   ...
   protected LootContext.Builder getLootContextBuilder(boolean attackedRecentlyIn, DamageSource damageSourceIn) {
      return super.getLootContextBuilder(attackedRecentlyIn, damageSourceIn).withSeededRandom(this.deathLootTableSeed, this.rand);
   }
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      this.getAttribute(Attributes.FOLLOW_RANGE).func_233769_c_(new AttributeModifier("Random spawn bonus", this.rand.nextGaussian() * 0.05D, AttributeModifier.Operation.MULTIPLY_BASE));
   ...
   public boolean attackEntityAsMob(Entity entityIn) {
      float f = (float)this.func_233637_b_(Attributes.ATTACK_DAMAGE);
      float f1 = (float)this.func_233637_b_(Attributes.ATTACK_KNOCKBACK);
      if (entityIn instanceof LivingEntity) {
