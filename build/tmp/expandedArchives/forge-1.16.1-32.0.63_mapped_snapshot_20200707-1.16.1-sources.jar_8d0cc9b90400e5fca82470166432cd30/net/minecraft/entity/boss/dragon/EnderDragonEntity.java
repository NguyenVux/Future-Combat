...
public class EnderDragonEntity extends MobEntity implements IMob {
   ...
   public static AttributeModifierMap.MutableAttribute func_234257_m_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.MAX_HEALTH, 200.0D);
   }
   ...
   /**
    * Generates values for the fields pathPoints
    */
   ...
   /**
    * Find and return a path among the circles described by pathPoints
    */
   @Nullable
   ...
   /**
    * Create and return a new PathEntity defining a path from the start to the finish
    */
