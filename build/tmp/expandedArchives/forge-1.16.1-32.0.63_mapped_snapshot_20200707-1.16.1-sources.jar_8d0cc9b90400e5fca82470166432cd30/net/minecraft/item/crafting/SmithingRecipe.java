...
public class SmithingRecipe implements IRecipe<IInventory> {
   ...
   public SmithingRecipe(ResourceLocation recipeIdIn, Ingredient baseIn, Ingredient additionIn, ItemStack resultIn) {
   ...
   public boolean isValidAdditionItem(ItemStack additionIn) {
      return this.addition.test(additionIn);
   }
