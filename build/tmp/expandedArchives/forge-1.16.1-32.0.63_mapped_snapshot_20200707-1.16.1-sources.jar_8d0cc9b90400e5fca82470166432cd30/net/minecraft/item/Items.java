...
public class Items {
   ...
   public static final Item NETHERITE_INGOT = register("netherite_ingot", new Item((new Item.Properties()).group(ItemGroup.MATERIALS).func_234689_a_()));
   public static final Item NETHERITE_SCRAP = register("netherite_scrap", new Item((new Item.Properties()).group(ItemGroup.MATERIALS).func_234689_a_()));
   ...
   public static final Item NETHERITE_SWORD = register("netherite_sword", new SwordItem(ItemTier.NETHERITE, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item NETHERITE_SHOVEL = register("netherite_shovel", new ShovelItem(ItemTier.NETHERITE, 1.5F, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   public static final Item NETHERITE_PICKAXE = register("netherite_pickaxe", new PickaxeItem(ItemTier.NETHERITE, 1, -2.8F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   public static final Item NETHERITE_AXE = register("netherite_axe", new AxeItem(ItemTier.NETHERITE, 5.0F, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   ...
   public static final Item NETHERITE_HOE = register("netherite_hoe", new HoeItem(ItemTier.NETHERITE, -4, 0.0F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   ...
   public static final Item NETHERITE_HELMET = register("netherite_helmet", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.HEAD, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item NETHERITE_CHESTPLATE = register("netherite_chestplate", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.CHEST, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item NETHERITE_LEGGINGS = register("netherite_leggings", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.LEGS, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item NETHERITE_BOOTS = register("netherite_boots", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.FEET, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   ...
   public static final Item NETHERITE_BRICKS = register(new BlockItem(Blocks.NETHERITE_BLOCK, (new Item.Properties()).group(ItemGroup.BUILDING_BLOCKS).func_234689_a_()));
   public static final Item ANCIENT_DEBRIS = register(new BlockItem(Blocks.ANCIENT_DEBRIS, (new Item.Properties()).group(ItemGroup.BUILDING_BLOCKS).func_234689_a_()));
