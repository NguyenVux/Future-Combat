...
public class EndGatewayTileEntity extends EndPortalTileEntity implements ITickableTileEntity {
   ...
   public void read(BlockState stateIn, CompoundNBT nbtIn) {
      ...
      this.age = nbtIn.getLong("Age");
      if (nbtIn.contains("ExitPortal", 10)) {
         this.exitPortal = NBTUtil.readBlockPos(nbtIn.getCompound("ExitPortal"));
      }

      this.exactTeleport = nbtIn.getBoolean("ExactTeleport");
   }
