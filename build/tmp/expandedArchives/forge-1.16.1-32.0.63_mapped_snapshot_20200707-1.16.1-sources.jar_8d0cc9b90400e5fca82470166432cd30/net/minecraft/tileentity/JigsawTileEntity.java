...
public class JigsawTileEntity extends TileEntity {
   ...
   public void read(BlockState stateIn, CompoundNBT nbtIn) {
      ...
      this.field_235658_a_ = new ResourceLocation(nbtIn.getString("name"));
      this.field_235659_b_ = new ResourceLocation(nbtIn.getString("target"));
      this.field_235660_c_ = new ResourceLocation(nbtIn.getString("pool"));
      this.finalState = nbtIn.getString("final_state");
      this.field_235661_g_ = JigsawTileEntity.OrientationType.func_235673_a_(nbtIn.getString("joint")).orElseGet(() -> {
         return JigsawBlock.func_235508_h_(stateIn).getAxis().isHorizontal() ? JigsawTileEntity.OrientationType.ALIGNED : JigsawTileEntity.OrientationType.ROLLABLE;
      });
   }
