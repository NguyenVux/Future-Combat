...
public class SkullTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   public void read(BlockState stateIn, CompoundNBT nbtIn) {
      ...
      if (nbtIn.contains("SkullOwner", 10)) {
         this.setPlayerProfile(NBTUtil.readGameProfile(nbtIn.getCompound("SkullOwner")));
      } else if (nbtIn.contains("ExtraType", 8)) {
         String s = nbtIn.getString("ExtraType");
