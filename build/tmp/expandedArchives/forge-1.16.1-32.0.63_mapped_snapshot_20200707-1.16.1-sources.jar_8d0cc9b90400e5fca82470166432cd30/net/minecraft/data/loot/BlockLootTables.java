...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   /**
    * Creates a builder that drops the given IItemProvider in amounts between 0 and 2
    */
   ...
   /**
    * Creates a builder that drops the given IItemProvider in amounts between 0 and 3
    */
   ...
   /**
    * Drops the first item parameter always
    */
   ...
   protected void addTables() {
      ...
      this.registerLootTable(Blocks.CRIMSON_NYLIUM, (p_239296_0_) -> {
         return droppingWithSilkTouch(p_239296_0_, Blocks.NETHERRACK);
      });
      this.registerLootTable(Blocks.WARPED_NYLIUM, (p_239293_0_) -> {
      ...
      this.registerLootTable(Blocks.WARPED_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.CRIMSON_DOOR, BlockLootTables::func_239829_a_);
      ...
      this.registerLootTable(Blocks.NETHER_GOLD_ORE, (p_218471_0_) -> {
      ...
      this.registerLootTable(Blocks.GILDED_BLACKSTONE, (p_229432_0_) -> {
      ...
      this.registerLootTable(Blocks.SOUL_CAMPFIRE, (p_218538_0_) -> {
         return droppingWithSilkTouch(p_218538_0_, withSurvivesExplosion(p_218538_0_, ItemLootEntry.builder(Items.SOUL_SOIL).acceptFunction(SetCount.builder(ConstantRange.of(1)))));
      });
      ...
      this.func_239830_b_(Blocks.WEEPING_VINES, Blocks.WEEPING_VINES_PLANT);
      this.func_239830_b_(Blocks.TWISTING_VINES, Blocks.TWISTING_VINES_PLANT);
